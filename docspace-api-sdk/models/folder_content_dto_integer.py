...
class FolderContentDtoInteger(BaseModel):
    ...
    """ # noqa: E501
    files: Optional[List[FileEntryDto]] = Field(default=None, description="The list of files in the folder.")
    folders: Optional[List[FileEntryDto]] = Field(default=None, description="The list of folders in the folder.")
