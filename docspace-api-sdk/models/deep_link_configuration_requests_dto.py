...
class DeepLinkConfigurationRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    deep_link_settings: Optional[TenantDeepLinkSettings] = Field(default=None, alias="deepLinkSettings")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of deep_link_settings
        if self.deep_link_settings:
            _dict['deepLinkSettings'] = self.deep_link_settings.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deepLinkSettings": TenantDeepLinkSettings.from_dict(obj["deepLinkSettings"]) if obj.get("deepLinkSettings") is not None else None
        })
        return _obj
