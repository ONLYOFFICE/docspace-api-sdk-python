...
class PeopleThemeApi:
    ...
    def change_portal_theme(
        ...
        :param dark_theme_settings_request_dto:
        :type dark_theme_settings_request_dto: DarkThemeSettingsRequestDto
    ...
    def change_portal_theme_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DarkThemeSettingsWrapper]:
        """Change the portal theme
    ...
    def _change_portal_theme_serialize(
        ...
        if dark_theme_settings_request_dto is not None:
            _body_params = dark_theme_settings_request_dto
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/2.0/people/theme',
