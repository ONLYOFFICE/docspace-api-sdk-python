...
class SettingsGreetingSettingsApi:
    ...
    def get_greeting_settings(
        ...
        _param = self._get_greeting_settings_serialize(
    ...
    @validate_call
    def get_greeting_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_greeting_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_greeting_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def restore_greeting_settings(
        ...
        _param = self._restore_greeting_settings_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def restore_greeting_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def restore_greeting_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _restore_greeting_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def save_greeting_settings(
        self,
        greeting_settings_requests_dto: Optional[GreetingSettingsRequestsDto] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._save_greeting_settings_serialize(
            greeting_settings_requests_dto=greeting_settings_requests_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def save_greeting_settings_with_http_info(
        self,
        greeting_settings_requests_dto: Optional[GreetingSettingsRequestsDto] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def save_greeting_settings_without_preload_content(
        self,
        greeting_settings_requests_dto: Optional[GreetingSettingsRequestsDto] = None,
        _request_timeout: Union[
            None,
    ...
    def _save_greeting_settings_serialize(
        self,
        greeting_settings_requests_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if greeting_settings_requests_dto is not None:
            _body_params = greeting_settings_requests_dto
