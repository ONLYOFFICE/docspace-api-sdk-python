# docspace-api-sdk.SettingsStorageApi
...
[**get_all_storages**](#get_all_storages) | **GET** /api/2.0/settings/storage | Get storages
[**get_amazon_s3_regions**](#get_amazon_s3_regions) | **GET** /api/2.0/settings/storage/s3/regions | Get Amazon regions
[**get_storage_progress**](#get_storage_progress) | **GET** /api/2.0/settings/storage/progress | Get the storage progress
...
[**update_storage**](#update_storage) | **PUT** /api/2.0/settings/storage | Update a storage
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-sdk.SettingsStorageApi(api_client)
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-sdk.SettingsStorageApi(api_client)
    storage_requests_dto = docspace-api-sdk.StorageRequestsDto() # StorageRequestsDto |  (optional)
