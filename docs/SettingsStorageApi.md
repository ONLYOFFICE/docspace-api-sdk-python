# docspace-api-python.SettingsStorageApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.SettingsStorageApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsStorageApi(api_client)
    storage_requests_dto = docspace-api-python.StorageRequestsDto() # StorageRequestsDto |  (optional)
