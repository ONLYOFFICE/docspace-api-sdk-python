...
**created_by** | [**EmployeeDto**](EmployeeDto.md) | The user who created the webhook. | [optional] 
**created_on** | **datetime** | The date and time when the webhook was created. | [optional] 
**modified_by** | [**EmployeeDto**](EmployeeDto.md) | The user who modified the webhook. | [optional] 
