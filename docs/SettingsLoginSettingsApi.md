# docspace-api-python.SettingsLoginSettingsApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.SettingsLoginSettingsApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsLoginSettingsApi(api_client)
    login_settings_request_dto = docspace-api-python.LoginSettingsRequestDto() # LoginSettingsRequestDto |  (optional)
