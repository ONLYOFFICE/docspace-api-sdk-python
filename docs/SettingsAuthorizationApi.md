# docspace-api-python.SettingsAuthorizationApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.SettingsAuthorizationApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsAuthorizationApi(api_client)
    auth_service_requests_dto = docspace-api-python.AuthServiceRequestsDto() # AuthServiceRequestsDto |  (optional)
