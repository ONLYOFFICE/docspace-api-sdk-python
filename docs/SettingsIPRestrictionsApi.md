# docspace-api-python.SettingsIPRestrictionsApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.SettingsIPRestrictionsApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsIPRestrictionsApi(api_client)
    ip_restrictions_dto = docspace-api-python.IpRestrictionsDto() # IpRestrictionsDto |  (optional)
