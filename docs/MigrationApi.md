# docspace-api-python.MigrationApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.MigrationApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.MigrationApi(api_client)
    finish_dto = docspace-api-python.FinishDto() # FinishDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.MigrationApi(api_client)
    migration_api_info = docspace-api-python.MigrationApiInfo() # MigrationApiInfo |  (optional)
