...
**auto_delete** | [**ApiDateTime**](ApiDateTime.md) | The date and time when the file entry will be automatically deleted. | [optional] 
...
**expiration_date** | [**ApiDateTime**](ApiDateTime.md) | Represents the expiration date of the file entry. | [optional] 
...
**editing_by** | **Dict[str, Optional[str]]** | The list of users editing the file. | [optional] 
...
**last_opened** | [**ApiDateTime**](ApiDateTime.md) | The time when the file was last opened. | [optional] 
