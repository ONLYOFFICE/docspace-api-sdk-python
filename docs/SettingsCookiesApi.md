...
with docspace.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace.SettingsCookiesApi(api_client)
...
with docspace.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace.SettingsCookiesApi(api_client)
    cookie_settings_requests_dto = docspace.CookieSettingsRequestsDto() # CookieSettingsRequestsDto |  (optional)
