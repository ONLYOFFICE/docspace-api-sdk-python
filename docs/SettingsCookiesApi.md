# docspace-api-sdk.SettingsCookiesApi
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-sdk.SettingsCookiesApi(api_client)
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-sdk.SettingsCookiesApi(api_client)
    cookie_settings_requests_dto = docspace-api-sdk.CookieSettingsRequestsDto() # CookieSettingsRequestsDto |  (optional)
