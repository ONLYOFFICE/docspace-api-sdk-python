...
json = "{}"
# create an instance of FolderDtoIntegerSecurity from a JSON string
folder_dto_integer_security_instance = FolderDtoIntegerSecurity.from_json(json)
# print the JSON string representation of the object
print(FolderDtoIntegerSecurity.to_json())

# convert the object into a dict
folder_dto_integer_security_dict = folder_dto_integer_security_instance.to_dict()
# create an instance of FolderDtoIntegerSecurity from a dict
folder_dto_integer_security_from_dict = FolderDtoIntegerSecurity.from_dict(folder_dto_integer_security_dict)
```
