# docspace-api-sdk.SecuritySMTPSettingsApi
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-sdk.SecuritySMTPSettingsApi(api_client)
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-sdk.SecuritySMTPSettingsApi(api_client)
    smtp_settings_dto = docspace-api-sdk.SmtpSettingsDto() # SmtpSettingsDto |  (optional)
