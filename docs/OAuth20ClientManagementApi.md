# docspace.OAuth20ClientManagementApi

All URIs are relative to *http://http:*

Method | HTTP request | Description
------------- | ------------- | -------------
[**change_activation**](OAuth20ClientManagementApi.md#change_activation) | **PATCH** /api/2.0/clients/{clientId}/activation | Change the client activation status
...
[**regenerate_secret**](OAuth20ClientManagementApi.md#regenerate_secret) | **PATCH** /api/2.0/clients/{clientId}/regenerate | Regenerate the client secret
...
with docspace.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace.OAuth20ClientManagementApi(api_client)
