# docspace-api-python.SettingsCommonSettingsApi
...
with docspace-api-python.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    wizard_requests_dto = docspace-api-python.WizardRequestsDto() # WizardRequestsDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    deep_link_configuration_requests_dto = docspace-api-python.DeepLinkConfigurationRequestsDto() # DeepLinkConfigurationRequestsDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    dns_settings_requests_dto = docspace-api-python.DnsSettingsRequestsDto() # DnsSettingsRequestsDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    mail_domain_settings_requests_dto = docspace-api-python.MailDomainSettingsRequestsDto() # MailDomainSettingsRequestsDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    custom_color_themes_settings_requests_dto = docspace-api-python.CustomColorThemesSettingsRequestsDto() # CustomColorThemesSettingsRequestsDto |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    email_activation_settings = docspace-api-python.EmailActivationSettings() # EmailActivationSettings |  (optional)
...
with docspace-api-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = docspace-api-python.SettingsCommonSettingsApi(api_client)
    tenant_user_invitation_settings_request_dto = docspace-api-python.TenantUserInvitationSettingsRequestDto() # TenantUserInvitationSettingsRequestDto |  (optional)
