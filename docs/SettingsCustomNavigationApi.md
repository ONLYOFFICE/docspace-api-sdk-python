# docspace_api_sdk.CustomNavigationApi
...
with docspace_api_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace_api_sdk.CustomNavigationApi(api_client)
    custom_navigation_item = docspace_api_sdk.CustomNavigationItem() # CustomNavigationItem |  (optional)
    ...
    try:
        ...
        print("The response of CustomNavigationApi->create_custom_navigation_item:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomNavigationApi->create_custom_navigation_item: %s\n" % e)
```
...
with docspace_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CustomNavigationApi->delete_custom_navigation_item: %s\n" % e)
```
...
with docspace_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CustomNavigationApi->get_custom_navigation_item:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomNavigationApi->get_custom_navigation_item: %s\n" % e)
```
...
with docspace_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CustomNavigationApi->get_custom_navigation_item_sample:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomNavigationApi->get_custom_navigation_item_sample: %s\n" % e)
```
...
with docspace_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CustomNavigationApi->get_custom_navigation_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomNavigationApi->get_custom_navigation_items: %s\n" % e)
```
