# docspace-api-sdk.PortalUsersApi
...
with docspace-api-sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = docspace-api-sdk.PortalUsersApi(api_client)
    employee_type = docspace-api-sdk.EmployeeType() # EmployeeType | The type of employee role for the invitation link (All, RoomAdmin, Guest, DocSpaceAdmin, User).
