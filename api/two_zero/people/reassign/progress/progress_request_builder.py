...
class ProgressRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/people/reassign/progress", path_parameters)
    
    def by_userid(self,userid: UUID) -> WithUserItemRequestBuilder:
        """
        Gets an item from the client.api.TwoZero.people.reassign.progress.item collection
        param userid: User ID whose data is reassigned
