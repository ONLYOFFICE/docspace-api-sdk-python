...
class FilterRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/people/simple/filter{?accountLoginType*,activationStatus*,area*,employeeStatus*,employeeType*,employeeTypes,excludeGroup*,groupId*,invitedByMe*,inviterId*,isAdministrator*,payments*,quotaFilter*,withoutGroup*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[FilterRequestBuilderGetQueryParameters]] = None) -> Optional[EmployeeDto]:
        """
