...
if TYPE_CHECKING:
    from .......models.a_s_c.people.api_models.request_dto.thumbnails_request import ThumbnailsRequest
...
class ThumbnailsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2.0/people/{userid}/photo/thumbnails
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/people/{userid}/photo/thumbnails", path_parameters)
    
    async def post(self,body: ThumbnailsRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ThumbnailsDataDto]:
        """
        Creates photo thumbnails by coordinates of the original image specified in the request.
        param body: Thumbnail request parameters
    ...
    def to_post_request_information(self,body: ThumbnailsRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates photo thumbnails by coordinates of the original image specified in the request.
        param body: Thumbnail request parameters
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
