...
if TYPE_CHECKING:
    from .......models.success_api_response_of_a_s_c.web.api.api_model.response_dto.login_event_dto import LoginEventDto
...
class FilterRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/security/audit/login/filter{?action*,from*,to*,userId*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[FilterRequestBuilderGetQueryParameters]] = None) -> Optional[LoginEventDto]:
        """
        Returns a list of the login events by the parameters specified in the request.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LoginEventDto]
        """
        ...
        return await self.request_adapter.send_async(request_info, LoginEventDto, None)
