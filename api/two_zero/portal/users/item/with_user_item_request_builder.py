...
if TYPE_CHECKING:
    from ......models.success_api_response_of_a_s_c.core.users.user_info import UserInfo
...
class WithUserItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/portal/users/{userID}", path_parameters)
