...
if TYPE_CHECKING:
    ...
    from .required.required_request_builder import RequiredRequestBuilder
...
class LicenseRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/settings/license", path_parameters)
    
    async def post(self,body: MultipartBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SuccessApiResponseOfAnonymous]:
        """
    ...
    def with_url(self,raw_url: str) -> LicenseRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: LicenseRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return LicenseRequestBuilder(self.request_adapter, raw_url)
    ...
    @property
    def required(self) -> RequiredRequestBuilder:
        """
        The required property
        """
        from .required.required_request_builder import RequiredRequestBuilder

        return RequiredRequestBuilder(self.request_adapter, self.path_parameters)
    
    @dataclass
    class LicenseRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
