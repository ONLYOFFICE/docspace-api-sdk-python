...
class RegionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/settings/storage/s3/regions", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RegionsRequestBuilder:
        """
        ...
        return RegionsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RegionsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
