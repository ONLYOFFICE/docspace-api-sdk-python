...
class RestoreRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/settings/whitelabel/restore{?IsDark*,IsDefault*}", path_parameters)
    
    async def put(self,request_configuration: Optional[RequestConfiguration[RestoreRequestBuilderPutQueryParameters]] = None) -> Optional[SuccessApiResponseOfAnonymous]:
        """
    ...
    def to_put_request_information(self,request_configuration: Optional[RequestConfiguration[RestoreRequestBuilderPutQueryParameters]] = None) -> RequestInformation:
        """
        Restores the white label options.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class RestoreRequestBuilderPutQueryParameters():
        """
        Restores the white label options.
        """
    ...
    @dataclass
    class RestoreRequestBuilderPutRequestConfiguration(RequestConfiguration[RestoreRequestBuilderPutQueryParameters]):
        """
