...
if TYPE_CHECKING:
    from .......models.success_api_response_of_a_s_c.files.core.api_models.response_dto.history_dto import HistoryDto
...
class LogRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/files/folder/{folder%2Did}/log{?fromDate*,toDate*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[LogRequestBuilderGetQueryParameters]] = None) -> Optional[HistoryDto]:
        """
        Get the activity history of a folder with a specified identifier
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[HistoryDto]
        """
        ...
        return await self.request_adapter.send_async(request_info, HistoryDto, None)
