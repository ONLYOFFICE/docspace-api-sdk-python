...
class RootRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/files/@root{?filterType*,searchInContent*,userIdOrGroupId*,withoutTrash*,withsubfolders*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RootRequestBuilderGetQueryParameters]] = None) -> Optional[int]:
        """
    ...
    class RootRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "without_trash":
                return "withoutTrash"
        ...
        without_trash: Optional[bool] = None
