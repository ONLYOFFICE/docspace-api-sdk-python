...
if TYPE_CHECKING:
    ...
    from .....models.a_s_c.files.core.api_models.request_dto.create_tag_request_dto import CreateTagRequestDto
...
class TagsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2.0/files/tags
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/files/tags", path_parameters)
    
    async def delete(self,body: BatchTagsRequestDto, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    async def post(self,body: CreateTagRequestDto, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SuccessApiResponseOfAnonymous]:
        """
        Creates a custom tag with the parameters specified in the request.
        param body: Request parameters for creating a tag
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SuccessApiResponseOfAnonymous]
        """
        if body is None:
    ...
    def to_post_request_information(self,body: CreateTagRequestDto, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a custom tag with the parameters specified in the request.
        param body: Request parameters for creating a tag
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
