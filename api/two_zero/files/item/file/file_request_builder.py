...
if TYPE_CHECKING:
    from ......models.a_s_c.files.core.api_models.request_dto.create_file.system.text.json.json_element import JsonElement
...
class FileRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/files/{file%2Did}/file", path_parameters)
    
    async def post(self,body: JsonElement, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[int]:
        """
        ...
        param body: Parameters for creating a file
