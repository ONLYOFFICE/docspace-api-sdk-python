...
class TrashRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2.0/files/@trash{?applyFilterOption*,filterType*,searchInContent*,userIdOrGroupId*,withsubfolders*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[TrashRequestBuilderGetQueryParameters]] = None) -> Optional[int]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TrashRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Returns the detailed list of files and folders located in the "Trash" section.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class TrashRequestBuilderGetQueryParameters():
        from uuid import UUID
    ...
    @dataclass
    class TrashRequestBuilderGetRequestConfiguration(RequestConfiguration[TrashRequestBuilderGetQueryParameters]):
        """
