...
if TYPE_CHECKING:
    ...
    from api.two_zero.authentication.authentication_request_builder import AuthenticationRequestBuilder
    from api.two_zero.files.my.my_request_builder import MyRequestBuilder
    from api.two_zero.files.folder.folder_request_builder import FolderRequestBuilder
...
class PostsClient(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter) -> None:
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "http://localhost:8092"
    ...
    @property
    def folderMy(self) -> MyRequestBuilder:
        from api.two_zero.files.my.my_request_builder import MyRequestBuilder
        return MyRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def createFolerInFolderMy(self) -> FolderRequestBuilder:
        from api.two_zero.files.folder.folder_request_builder import FolderRequestBuilder
