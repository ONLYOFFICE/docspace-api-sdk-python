...
class TestGroupWrapper(unittest.TestCase):
    """GroupWrapper unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupWrapper:
        """Test GroupWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupWrapper`
        """
        model = GroupWrapper()
        if include_optional:
            return GroupWrapper(
                response = docspace.models.group_dto.GroupDto(
                    name = 'Winfield Upton', 
