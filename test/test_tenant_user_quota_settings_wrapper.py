...
class TestTenantUserQuotaSettingsWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TenantUserQuotaSettingsWrapper:
        """Test TenantUserQuotaSettingsWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantUserQuotaSettingsWrapper`
        """
        model = TenantUserQuotaSettingsWrapper()
        if include_optional:
            return TenantUserQuotaSettingsWrapper(
                response = docspace.models.tenant_user_quota_settings.TenantUserQuotaSettings(
                    enable_quota = True, 
                    default_quota = 1234, 
    ...
    def testTenantUserQuotaSettingsWrapper(self):
        """Test TenantUserQuotaSettingsWrapper"""
