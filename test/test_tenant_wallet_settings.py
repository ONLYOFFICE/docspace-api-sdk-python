...
class TestTenantWalletSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TenantWalletSettings:
        """Test TenantWalletSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantWalletSettings`
        """
        model = TenantWalletSettings()
        if include_optional:
            return TenantWalletSettings(
                enabled = True,
                min_balance = 1234,
                up_to_balance = 1234,
                currency = 'some text',
    ...
    def testTenantWalletSettings(self):
        """Test TenantWalletSettings"""
