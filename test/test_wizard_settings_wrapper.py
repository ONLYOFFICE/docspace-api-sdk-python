...
class TestWizardSettingsWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WizardSettingsWrapper:
        """Test WizardSettingsWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WizardSettingsWrapper`
        """
        model = WizardSettingsWrapper()
        if include_optional:
            return WizardSettingsWrapper(
                response = docspace.models.wizard_settings.WizardSettings(
                    completed = True, 
    ...
    def testWizardSettingsWrapper(self):
        """Test WizardSettingsWrapper"""
