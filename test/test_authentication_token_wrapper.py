...
class TestAuthenticationTokenWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthenticationTokenWrapper:
        """Test AuthenticationTokenWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationTokenWrapper`
        """
        model = AuthenticationTokenWrapper()
        if include_optional:
            return AuthenticationTokenWrapper(
                response = docspace-api-sdk.models.authentication_token_dto.AuthenticationTokenDto(
                    token = 'abcde12345', 
    ...
    def testAuthenticationTokenWrapper(self):
        """Test AuthenticationTokenWrapper"""
