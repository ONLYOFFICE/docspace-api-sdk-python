...
class TestStorageArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StorageArrayWrapper:
        """Test StorageArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageArrayWrapper`
        """
        model = StorageArrayWrapper()
        if include_optional:
            return StorageArrayWrapper(
                response = [
                    docspace.models.storage_dto.StorageDto(
                        id = '9846', 
    ...
    def testStorageArrayWrapper(self):
        """Test StorageArrayWrapper"""
