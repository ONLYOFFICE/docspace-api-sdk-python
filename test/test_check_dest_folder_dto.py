...
class TestCheckDestFolderDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CheckDestFolderDto:
        """Test CheckDestFolderDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDestFolderDto`
        """
    ...
    def testCheckDestFolderDto(self):
        """Test CheckDestFolderDto"""
