...
class TestFolderIntegerArrayWrapper(unittest.TestCase):
    """FolderIntegerArrayWrapper unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderIntegerArrayWrapper:
        """Test FolderIntegerArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderIntegerArrayWrapper`
        """
        model = FolderIntegerArrayWrapper()
        if include_optional:
            return FolderIntegerArrayWrapper(
                response = [
                    docspace-api-python.models.folder_dto_integer.FolderDtoInteger(
    ...
    def testFolderIntegerArrayWrapper(self):
        """Test FolderIntegerArrayWrapper"""
