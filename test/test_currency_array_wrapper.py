...
class TestCurrencyArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyArrayWrapper:
        """Test CurrencyArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyArrayWrapper`
        """
        model = CurrencyArrayWrapper()
        if include_optional:
    ...
    def testCurrencyArrayWrapper(self):
        """Test CurrencyArrayWrapper"""
