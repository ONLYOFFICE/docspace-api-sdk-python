...
class TestAuditEventArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuditEventArrayWrapper:
        """Test AuditEventArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditEventArrayWrapper`
        """
        model = AuditEventArrayWrapper()
        if include_optional:
            return AuditEventArrayWrapper(
                response = [
                    docspace.models.audit_event_dto.AuditEventDto(
                        id = 9846, 
    ...
    def testAuditEventArrayWrapper(self):
        """Test AuditEventArrayWrapper"""
