...
class TestFireBaseUserWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FireBaseUserWrapper:
        """Test FireBaseUserWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FireBaseUserWrapper`
        """
        model = FireBaseUserWrapper()
        if include_optional:
            return FireBaseUserWrapper(
                response = docspace.models.fire_base_user.FireBaseUser(
                    id = 9846, 
    ...
    def testFireBaseUserWrapper(self):
        """Test FireBaseUserWrapper"""
