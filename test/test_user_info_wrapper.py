...
class TestUserInfoWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserInfoWrapper:
        """Test UserInfoWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInfoWrapper`
        """
        model = UserInfoWrapper()
        if include_optional:
            return UserInfoWrapper(
                response = docspace-api-sdk.models.user_info.UserInfo(
