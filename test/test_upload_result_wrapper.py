...
class TestUploadResultWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UploadResultWrapper:
        """Test UploadResultWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadResultWrapper`
        """
        model = UploadResultWrapper()
        if include_optional:
            return UploadResultWrapper(
                response = docspace.models.upload_result_dto.UploadResultDto(
                    success = True, 
    ...
    def testUploadResultWrapper(self):
        """Test UploadResultWrapper"""
