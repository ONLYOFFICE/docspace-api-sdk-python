...
class TestBackupHistoryRecordArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BackupHistoryRecordArrayWrapper:
        """Test BackupHistoryRecordArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupHistoryRecordArrayWrapper`
        """
        model = BackupHistoryRecordArrayWrapper()
        if include_optional:
            return BackupHistoryRecordArrayWrapper(
                response = [
                    docspace.models.backup_history_record.BackupHistoryRecord(
    ...
    def testBackupHistoryRecordArrayWrapper(self):
        """Test BackupHistoryRecordArrayWrapper"""
