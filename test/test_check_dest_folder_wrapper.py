...
class TestCheckDestFolderWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CheckDestFolderWrapper:
        """Test CheckDestFolderWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDestFolderWrapper`
        """
        model = CheckDestFolderWrapper()
        if include_optional:
            return CheckDestFolderWrapper(
                response = docspace-api-sdk.models.check_dest_folder_dto.CheckDestFolderDto(
                    result = 0, 
                    files = [
    ...
    def testCheckDestFolderWrapper(self):
        """Test CheckDestFolderWrapper"""
