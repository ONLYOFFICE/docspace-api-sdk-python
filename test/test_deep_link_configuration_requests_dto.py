...
class TestDeepLinkConfigurationRequestsDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeepLinkConfigurationRequestsDto:
        """Test DeepLinkConfigurationRequestsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeepLinkConfigurationRequestsDto`
        """
        model = DeepLinkConfigurationRequestsDto()
        if include_optional:
            return DeepLinkConfigurationRequestsDto(
                deep_link_settings = docspace-api-sdk.models.tenant_deep_link_settings.TenantDeepLinkSettings(
                    handling_mode = 0, 
    ...
    def testDeepLinkConfigurationRequestsDto(self):
        """Test DeepLinkConfigurationRequestsDto"""
