...
class TestLoginEventArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoginEventArrayWrapper:
        """Test LoginEventArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginEventArrayWrapper`
        """
        model = LoginEventArrayWrapper()
        if include_optional:
            return LoginEventArrayWrapper(
                response = [
                    docspace-api-sdk.models.login_event_dto.LoginEventDto(
                        id = 9846, 
    ...
    def testLoginEventArrayWrapper(self):
        """Test LoginEventArrayWrapper"""
