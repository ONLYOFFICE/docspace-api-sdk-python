...
class TestFileOperationArrayWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileOperationArrayWrapper:
        """Test FileOperationArrayWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationArrayWrapper`
        """
        model = FileOperationArrayWrapper()
        if include_optional:
            return FileOperationArrayWrapper(
                response = [
                    docspace-api-sdk.models.file_operation_dto.FileOperationDto(
                        id = '9846', 
                        operation = 0, 
                        progress = 100, 
                        error = '', 
    ...
    def testFileOperationArrayWrapper(self):
        """Test FileOperationArrayWrapper"""
