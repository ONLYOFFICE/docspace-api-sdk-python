...
class TestFolderDtoInteger(unittest.TestCase):
    """FolderDtoInteger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderDtoInteger:
        """Test FolderDtoInteger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderDtoInteger`
        """
        model = FolderDtoInteger()
        if include_optional:
            return FolderDtoInteger(
                ...
                updated = docspace-api-sdk.models.api_date_time.ApiDateTime(
                    utc_time = '2008-04-10T06:30+04:00', 
                    time_zone_offset = '00:00:00', ),
                auto_delete = docspace-api-sdk.models.api_date_time.ApiDateTime(
                    utc_time = '2008-04-10T06:30+04:00', 
                    time_zone_offset = '00:00:00', ),
                root_folder_type = 0,
                parent_room_type = 0,
