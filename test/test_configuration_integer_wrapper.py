    ...
    def make_instance(self, include_optional) -> ConfigurationIntegerWrapper:
        ...
        if include_optional:
            return ConfigurationIntegerWrapper(
                response = docspace-api-sdk.models.configuration_dto_integer.ConfigurationDtoInteger(
                    document = docspace-api-sdk.models.document_config_dto.DocumentConfigDto(
                        file_type = 'some text', 
                    ...
                    editor_config = docspace-api-sdk.models.editor_configuration_dto.EditorConfigurationDto(
                    ...
                    token = 'some text', 
                    type = 'some text', 
                    file = docspace-api-sdk.models.file_dto_integer.FileDtoInteger(
