...
class TestSetupCodeWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetupCodeWrapper:
        """Test SetupCodeWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetupCodeWrapper`
        """
        model = SetupCodeWrapper()
        if include_optional:
            return SetupCodeWrapper(
                response = docspace-api-sdk.models.setup_code.SetupCode(
                    account = 'some text', 
