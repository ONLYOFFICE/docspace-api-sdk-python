...
class TestFileShareWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileShareWrapper:
        """Test FileShareWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileShareWrapper`
        """
        model = FileShareWrapper()
        if include_optional:
            return FileShareWrapper(
                response = docspace-api-sdk.models.file_share_dto.FileShareDto(
                    access = 0, 
