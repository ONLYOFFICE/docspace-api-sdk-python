...
class TestFillingFormResultDtoInteger(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FillingFormResultDtoInteger:
        """Test FillingFormResultDtoInteger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FillingFormResultDtoInteger`
        """
        model = FillingFormResultDtoInteger()
        if include_optional:
            return FillingFormResultDtoInteger(
                form_number = 1234,
                completed_form = docspace.models.file_dto_integer.FileDtoInteger(
                    ...
                    expired = , 
                    file_entry_type = 1, ),
                original_form = docspace.models.file_dto_integer.FileDtoInteger(
                    title = 'Some titile.txt/ Some title', 
                    access = 0, 
                    shared = False, 
                    created = docspace.models.api_date_time.ApiDateTime(
    ...
    def testFillingFormResultDtoInteger(self):
        """Test FillingFormResultDtoInteger"""
