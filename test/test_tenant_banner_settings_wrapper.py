...
class TestTenantBannerSettingsWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TenantBannerSettingsWrapper:
        """Test TenantBannerSettingsWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantBannerSettingsWrapper`
        """
    ...
    def testTenantBannerSettingsWrapper(self):
        """Test TenantBannerSettingsWrapper"""
