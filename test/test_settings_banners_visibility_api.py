...
class TestSettingsBannersVisibilityApi(unittest.TestCase):
    """SettingsBannersVisibilityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SettingsBannersVisibilityApi()

    def tearDown(self) -> None:
        pass

    def test_get_tenant_banner_settings(self) -> None:
        """Test case for get_tenant_banner_settings
