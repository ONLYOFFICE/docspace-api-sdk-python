...
class TestSecurityBannersVisibilityApi(unittest.TestCase):
    """SecurityBannersVisibilityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SecurityBannersVisibilityApi()

    def tearDown(self) -> None:
        pass

    def test_set_tenant_banner_settings(self) -> None:
        """Test case for set_tenant_banner_settings
