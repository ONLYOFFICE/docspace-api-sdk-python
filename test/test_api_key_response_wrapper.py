...
class TestApiKeyResponseWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiKeyResponseWrapper:
        """Test ApiKeyResponseWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyResponseWrapper`
        """
        model = ApiKeyResponseWrapper()
        if include_optional:
            return ApiKeyResponseWrapper(
                response = docspace-api-sdk.models.api_key_response_dto.ApiKeyResponseDto(
    ...
    def testApiKeyResponseWrapper(self):
        """Test ApiKeyResponseWrapper"""
