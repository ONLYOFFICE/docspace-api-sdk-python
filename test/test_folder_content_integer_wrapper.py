...
class TestFolderContentIntegerWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FolderContentIntegerWrapper:
        """Test FolderContentIntegerWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderContentIntegerWrapper`
        """
        model = FolderContentIntegerWrapper()
        if include_optional:
            return FolderContentIntegerWrapper(
                response = docspace-api-sdk.models.folder_content_dto_integer.FolderContentDtoInteger(
                    files = [
    ...
    def testFolderContentIntegerWrapper(self):
        """Test FolderContentIntegerWrapper"""
