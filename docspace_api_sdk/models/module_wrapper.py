...
class ModuleWrapper(BaseModel):
    ...
    """ # noqa: E501
    response: Optional[Module] = Field(default=None, description="The Module object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": Module.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
