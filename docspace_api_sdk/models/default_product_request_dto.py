...
class DefaultProductRequestDto(BaseModel):
    """
    The request parameters for setting the default product configuration.
    """ # noqa: E501
    default_folder_type: FolderType = Field(description="The ID of the product to be set as default.", alias="defaultFolderType")
