...
class BuyWalletServiceRequestDto(BaseModel):
    """
    The request parameters for buying wallet service.
    """ # noqa: E501
    quantity: Optional[Annotated[int, Field(le=999999, strict=True, ge=1)]] = Field(default=None, description="Number of services provided.")
    service_name: Optional[StrictStr] = Field(default=None, description="The service name.", alias="serviceName")
    __properties: ClassVar[List[str]] = ["quantity", "serviceName"]
