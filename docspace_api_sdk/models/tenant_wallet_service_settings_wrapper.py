...
class TenantWalletServiceSettingsWrapper(BaseModel):
    """
    The successful API response containing the TenantWalletServiceSettings object.
    """ # noqa: E501
    response: Optional[TenantWalletServiceSettings] = Field(default=None, description="The TenantWalletServiceSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantWalletServiceSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
