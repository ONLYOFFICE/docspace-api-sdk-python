...
class AiAgentNewItemsDto(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": AiFileEntryBaseDto.from_dict(obj["agent"]) if obj.get("agent") is not None else None,
            "items": [AiFileEntryBaseDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
