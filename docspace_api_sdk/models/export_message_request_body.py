...
class ExportMessageRequestBody(BaseModel):
    """
    Parameters for exporting an AI chat message to a document.
    """ # noqa: E501
    folder_id: ExportChatRequestBodyFolderId = Field(alias="folderId")
    title: Optional[StrictStr] = Field(description="The file name (without extension) to use for the exported document.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "folderId": ExportChatRequestBodyFolderId.from_dict(obj["folderId"]) if obj.get("folderId") is not None else None,
            "title": obj.get("title")
        })
        return _obj
