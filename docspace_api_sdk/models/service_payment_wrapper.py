...
class ServicePaymentWrapper(BaseModel):
    """
    ServicePaymentWrapper
    """ # noqa: E501
    response: Optional[ServicePayment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ServicePayment.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
