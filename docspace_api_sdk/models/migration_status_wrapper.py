...
class MigrationStatusWrapper(BaseModel):
    """
    The successful API response containing the MigrationStatusDto object.
    """ # noqa: E501
    response: Optional[MigrationStatusDto] = Field(default=None, description="The MigrationStatusDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": MigrationStatusDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
