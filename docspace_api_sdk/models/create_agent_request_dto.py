...
class CreateAgentRequestDto(BaseModel):
    ...
    attach_default_tools: Optional[StrictBool] = Field(default=None, description="Specifies whether to attach default tools to the agent or not.", alias="attachDefaultTools")
    __properties: ClassVar[List[str]] = ["title", "quota", "indexing", "denyDownload", "lifetime", "watermark", "logo", "tags", "color", "cover", "private", "share", "chatSettings", "attachDefaultTools"]
