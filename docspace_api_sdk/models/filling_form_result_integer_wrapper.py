...
class FillingFormResultIntegerWrapper(BaseModel):
    """
    The successful API response containing the FillingFormResultDtoInteger object.
    """ # noqa: E501
    response: Optional[FillingFormResultDtoInteger] = Field(default=None, description="The FillingFormResultDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FillingFormResultDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
