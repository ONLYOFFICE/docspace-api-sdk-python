...
class FileEntryDtoString(FileEntryBaseDto):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The file entry ID.", json_schema_extra={"examples": ["10"]})
    root_folder_id: Optional[StrictStr] = Field(default=None, description="The root folder ID of the file entry.", alias="rootFolderId", json_schema_extra={"examples": ["1"]})
    origin_id: Optional[StrictStr] = Field(default=None, description="The origin ID of the file entry.", alias="originId", json_schema_extra={"examples": ["12"]})
    origin_room_id: Optional[StrictStr] = Field(default=None, description="The origin room ID of the file entry.", alias="originRoomId", json_schema_extra={"examples": ["22"]})
