...
class BackupProgressWrapper(BaseModel):
    """
    The successful API response containing the BackupProgress object.
    """ # noqa: E501
    response: Optional[BackupProgress] = Field(default=None, description="The BackupProgress object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": BackupProgress.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
