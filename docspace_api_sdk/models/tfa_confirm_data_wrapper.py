...
class TfaConfirmDataWrapper(BaseModel):
    """
    The successful API response containing the TfaConfirmDataDto object.
    """ # noqa: E501
    response: Optional[TfaConfirmDataDto] = Field(default=None, description="The TfaConfirmDataDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TfaConfirmDataDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
