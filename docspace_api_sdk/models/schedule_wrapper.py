...
class ScheduleWrapper(BaseModel):
    """
    The successful API response containing the ScheduleDto object.
    """ # noqa: E501
    response: Optional[ScheduleDto] = Field(default=None, description="The ScheduleDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ScheduleDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
