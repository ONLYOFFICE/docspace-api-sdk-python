...
class EncryptionKeyArrayWrapper(BaseModel):
    """
    The successful API response containing the list of EncryptionKeyDto objects.
    """ # noqa: E501
    response: Optional[List[EncryptionKeyDto]] = Field(default=None, description="The list of EncryptionKeyDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [EncryptionKeyDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
