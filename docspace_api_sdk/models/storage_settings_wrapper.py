...
class StorageSettingsWrapper(BaseModel):
    """
    The successful API response containing the StorageSettings object.
    """ # noqa: E501
    response: Optional[StorageSettings] = Field(default=None, description="The StorageSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": StorageSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
