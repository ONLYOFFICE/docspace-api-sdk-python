...
class AiVectorizationSettingsWrapper(BaseModel):
    """
    The successful API response containing the VectorizationSettingsDto object.
    """ # noqa: E501
    response: Optional[AiVectorizationSettingsDto] = Field(default=None, description="The VectorizationSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiVectorizationSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
