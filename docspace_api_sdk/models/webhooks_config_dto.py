...
class WebhooksConfigDto(BaseModel):
    ...
    created_by: Optional[EmployeeDto] = Field(default=None, description="The user who created the webhook.", alias="createdBy")
    ...
    modified_by: Optional[EmployeeDto] = Field(default=None, description="The user who modified the webhook.", alias="modifiedBy")
