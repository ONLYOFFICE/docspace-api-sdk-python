...
class AdditionalWhiteLabelSettingsWrapper(BaseModel):
    """
    The additional white label settings wrapper.
    """ # noqa: E501
    settings: Optional[AdditionalWhiteLabelSettings] = Field(default=None, description="The additional white label settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": AdditionalWhiteLabelSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
