...
class AiWatermarkDto(BaseModel):
    """
    The watermark settings.
    """ # noqa: E501
    additions: AiWatermarkAdditions = Field(description="Specifies whether to display in the watermark: username, user email, user ip-adress, current date, and room name.")
    ...
    image_height: Union[StrictFloat, StrictInt] = Field(description="The watermark image height.", alias="imageHeight", json_schema_extra={"examples": [100]})
    image_width: Union[StrictFloat, StrictInt] = Field(description="The watermark image width.", alias="imageWidth", json_schema_extra={"examples": [200]})
