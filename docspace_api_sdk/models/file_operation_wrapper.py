...
class FileOperationWrapper(BaseModel):
    """
    The successful API response containing the FileOperationDto object.
    """ # noqa: E501
    response: Optional[FileOperationDto] = Field(default=None, description="The FileOperationDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileOperationDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
