...
class AgentNewItemsDto(BaseModel):
    """
    The agent new item's information.
    """ # noqa: E501
    agent: FileEntryBaseDto
    items: Optional[List[FileEntryBaseDto]] = Field(description="The list of file entry items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": FileEntryBaseDto.from_dict(obj["agent"]) if obj.get("agent") is not None else None,
            "items": [FileEntryBaseDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
