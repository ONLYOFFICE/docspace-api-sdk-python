...
class FireBaseUserWrapper(BaseModel):
    """
    The successful API response containing the FireBaseUser object.
    """ # noqa: E501
    response: Optional[FireBaseUser] = Field(default=None, description="The FireBaseUser object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FireBaseUser.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
