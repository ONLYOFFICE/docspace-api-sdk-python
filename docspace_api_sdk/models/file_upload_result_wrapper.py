...
class FileUploadResultWrapper(BaseModel):
    """
    The successful API response containing the FileUploadResultDto object.
    """ # noqa: E501
    response: Optional[FileUploadResultDto] = Field(default=None, description="The FileUploadResultDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileUploadResultDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
