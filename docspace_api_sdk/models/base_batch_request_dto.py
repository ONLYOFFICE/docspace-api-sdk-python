...
class BaseBatchRequestDto(FileOperationRequestBaseDto):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        extra_fields = {
            "folderIds": [BaseBatchRequestDtoAllOfFolderIds.from_dict(_item) for _item in obj["folderIds"]] if obj.get("folderIds") is not None else None,
            "fileIds": [BaseBatchRequestDtoAllOfFileIds.from_dict(_item) for _item in obj["fileIds"]] if obj.get("fileIds") is not None else None
        }
