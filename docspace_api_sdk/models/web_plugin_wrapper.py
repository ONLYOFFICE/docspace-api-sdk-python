...
class WebPluginWrapper(BaseModel):
    """
    The successful API response containing the WebPluginDto object.
    """ # noqa: E501
    response: Optional[WebPluginDto] = Field(default=None, description="The WebPluginDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": WebPluginDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
