...
class FormResultsDto(BaseModel):
    """
    FormResultsDto
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in forms_data (list)
        _items = []
        if self.forms_data:
            for _item_forms_data in self.forms_data:
                if _item_forms_data:
                    _items.append(_item_forms_data.to_dict())
            _dict['formsData'] = _items
        # set to None if forms_data (nullable) is None
        # and model_fields_set contains the field
        if self.forms_data is None and "forms_data" in self.model_fields_set:
            _dict['formsData'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formsData": [FormsItemData.from_dict(_item) for _item in obj["formsData"]] if obj.get("formsData") is not None else None
        })
        return _obj
