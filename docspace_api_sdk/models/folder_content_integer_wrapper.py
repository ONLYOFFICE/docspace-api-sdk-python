...
class FolderContentIntegerWrapper(BaseModel):
    """
    The successful API response containing the FolderContentDtoInteger object.
    """ # noqa: E501
    response: Optional[FolderContentDtoInteger] = Field(default=None, description="The FolderContentDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FolderContentDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
