...
class DocsCloudServerInfo(BaseModel):
    ...
    var_date: Optional[datetime] = Field(default=None, description="The server build date.", alias="date", json_schema_extra={"examples": ["2024-01-15T10:30:00Z"]})
    __properties: ClassVar[List[str]] = ["version", "packageType", "date"]
