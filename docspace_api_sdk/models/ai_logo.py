...
class AiLogo(BaseModel):
    ...
    cover: Optional[AiLogoCover] = Field(default=None, description="The logo cover.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "small": obj.get("small"),
            "color": obj.get("color"),
            "cover": AiLogoCover.from_dict(obj["cover"]) if obj.get("cover") is not None else None
        })
        return _obj
