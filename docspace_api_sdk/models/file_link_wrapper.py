...
class FileLinkWrapper(BaseModel):
    """
    The successful API response containing the FileLink object.
    """ # noqa: E501
    response: Optional[FileLink] = Field(default=None, description="The FileLink object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileLink.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
