...
class OwnerChangeInstructionsWrapper(BaseModel):
    """
    The successful API response containing the OwnerChangeInstructionsDto object.
    """ # noqa: E501
    response: Optional[OwnerChangeInstructionsDto] = Field(default=None, description="The OwnerChangeInstructionsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": OwnerChangeInstructionsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
