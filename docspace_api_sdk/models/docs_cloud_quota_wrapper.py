...
class DocsCloudQuotaWrapper(BaseModel):
    """
    The successful API response containing the DocsCloudQuota object.
    """ # noqa: E501
    response: Optional[DocsCloudQuota] = Field(default=None, description="The DocsCloudQuota object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DocsCloudQuota.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
