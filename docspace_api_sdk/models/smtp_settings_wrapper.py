...
class SmtpSettingsWrapper(BaseModel):
    """
    The successful API response containing the SmtpSettingsDto object.
    """ # noqa: E501
    response: Optional[SmtpSettingsDto] = Field(default=None, description="The SmtpSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SmtpSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
