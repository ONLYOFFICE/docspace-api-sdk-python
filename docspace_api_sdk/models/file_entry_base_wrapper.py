...
class FileEntryBaseWrapper(BaseModel):
    """
    The successful API response containing the FileEntryBaseDto object.
    """ # noqa: E501
    response: Optional[FileEntryBaseDto] = Field(default=None, description="The FileEntryBaseDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileEntryBaseDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
