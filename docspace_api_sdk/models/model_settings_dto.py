...
class ModelSettingsDto(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(description="The model identifier.")
    ...
    is_recommended: Optional[StrictBool] = Field(default=None, description="Whether the model is recommended (defined in configuration).", alias="isRecommended")
    capabilities: AiModelCapabilities
    __properties: ClassVar[List[str]] = ["id", "alias", "isEnabled", "isRecommended", "capabilities"]
