...
class FilesSettingsDto(BaseModel):
    ...
    """ # noqa: E501
    exts_image_previewed: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the viewed images.", alias="extsImagePreviewed", json_schema_extra={"examples": [[".bmp", ".gif", ".jpeg", ".jpg", ".png", ".svg"]]})
    exts_media_previewed: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the viewed media files.", alias="extsMediaPreviewed", json_schema_extra={"examples": [[".mp4", ".webm", ".mp3", ".ogg"]]})
    exts_web_previewed: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the viewed files.", alias="extsWebPreviewed", json_schema_extra={"examples": [[".docx", ".xlsx", ".pptx", ".pdf"]]})
    exts_web_edited: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the edited files.", alias="extsWebEdited", json_schema_extra={"examples": [[".docx", ".xlsx", ".pptx"]]})
    exts_web_encrypt: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the encrypted files.", alias="extsWebEncrypt", json_schema_extra={"examples": [[".docx", ".xlsx", ".pptx"]]})
    exts_web_reviewed: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the reviewed files.", alias="extsWebReviewed", json_schema_extra={"examples": [[".docx"]]})
    exts_web_custom_filter_editing: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the custom filter files.", alias="extsWebCustomFilterEditing", json_schema_extra={"examples": [[".xlsx"]]})
    exts_web_restricted_editing: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the files that are restricted for editing.", alias="extsWebRestrictedEditing", json_schema_extra={"examples": [[".pdf"]]})
    exts_web_commented: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the commented files.", alias="extsWebCommented", json_schema_extra={"examples": [[".docx"]]})
    exts_web_template: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the template files.", alias="extsWebTemplate", json_schema_extra={"examples": [[".docx", ".xlsx", ".pptx"]]})
    exts_must_convert: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the files that must be converted.", alias="extsMustConvert", json_schema_extra={"examples": [[".doc", ".xls", ".ppt"]]})
    exts_convertible: Optional[Dict[str, Optional[List[StrictStr]]]] = Field(default=None, description="The list of the convertible extensions.", alias="extsConvertible", json_schema_extra={"examples": [{".doc": [".docx", ".pdf"], ".xls": [".xlsx", ".pdf"]}]})
    exts_uploadable: Optional[List[StrictStr]] = Field(default=None, description="The list of the uploadable extensions.", alias="extsUploadable", json_schema_extra={"examples": [[".docx", ".xlsx", ".pdf"]]})
    exts_archive: Optional[List[StrictStr]] = Field(default=None, description="The list of extensions of the archive files.", alias="extsArchive", json_schema_extra={"examples": [[".zip", ".rar", ".7z"]]})
    exts_video: Optional[List[StrictStr]] = Field(default=None, description="The list of the video extensions.", alias="extsVideo", json_schema_extra={"examples": [[".mp4", ".webm", ".avi"]]})
    exts_audio: Optional[List[StrictStr]] = Field(default=None, description="The list of the audio extensions.", alias="extsAudio", json_schema_extra={"examples": [[".mp3", ".ogg", ".wav"]]})
    exts_image: Optional[List[StrictStr]] = Field(default=None, description="The list of the image extensions.", alias="extsImage", json_schema_extra={"examples": [[".png", ".jpg", ".gif"]]})
    exts_spreadsheet: Optional[List[StrictStr]] = Field(default=None, description="The list of the spreadsheet extensions.", alias="extsSpreadsheet", json_schema_extra={"examples": [[".xlsx", ".xls", ".ods"]]})
    exts_presentation: Optional[List[StrictStr]] = Field(default=None, description="The list of the presentation extensions.", alias="extsPresentation", json_schema_extra={"examples": [[".pptx", ".ppt", ".odp"]]})
    exts_document: Optional[List[StrictStr]] = Field(default=None, description="The list of the text document extensions.", alias="extsDocument", json_schema_extra={"examples": [[".docx", ".doc", ".odt"]]})
    exts_diagram: Optional[List[StrictStr]] = Field(default=None, description="The list of the diagram extensions.", alias="extsDiagram", json_schema_extra={"examples": [[".vsdx"]]})
    internal_formats: Optional[FilesSettingsDtoInternalFormats] = Field(default=None, alias="internalFormats")
    master_form_extension: Optional[StrictStr] = Field(default=None, description="The master form extension.", alias="masterFormExtension", json_schema_extra={"examples": [".docxf"]})
    param_version: Optional[StrictStr] = Field(default=None, description="The URL parameter which specifies the file version.", alias="paramVersion", json_schema_extra={"examples": ["ver"]})
    param_out_type: Optional[StrictStr] = Field(default=None, description="The URL parameter which specifies the output type of the converted file.", alias="paramOutType", json_schema_extra={"examples": ["otype"]})
    file_download_url_string: Optional[StrictStr] = Field(default=None, description="The URL to download a file.", alias="fileDownloadUrlString", json_schema_extra={"examples": ["https://example.com/products/files/httphandlers/filehandler.ashx?action=download&fileid={0}"]})
    file_web_viewer_url_string: Optional[StrictStr] = Field(default=None, description="The URL to the file web viewer.", alias="fileWebViewerUrlString", json_schema_extra={"examples": ["/products/files/doceditor?fileid={0}&action=view"]})
    file_web_viewer_external_url_string: Optional[StrictStr] = Field(default=None, description="The external URL to the file web viewer.", alias="fileWebViewerExternalUrlString", json_schema_extra={"examples": ["https://example.com/products/files/doceditor?fileid={0}&action=view"]})
    file_web_editor_url_string: Optional[StrictStr] = Field(default=None, description="The URL to the file web editor.", alias="fileWebEditorUrlString", json_schema_extra={"examples": ["/products/files/doceditor?fileid={0}&action=edit"]})
    file_web_editor_external_url_string: Optional[StrictStr] = Field(default=None, description="The external URL to the file web editor.", alias="fileWebEditorExternalUrlString", json_schema_extra={"examples": ["https://example.com/products/files/doceditor?fileid={0}&action=edit"]})
    file_redirect_preview_url_string: Optional[StrictStr] = Field(default=None, description="The redirect URL to the file viewer.", alias="fileRedirectPreviewUrlString", json_schema_extra={"examples": ["https://example.com/products/files/{0}"]})
    file_thumbnail_url_string: Optional[StrictStr] = Field(default=None, description="The URL to the file thumbnail.", alias="fileThumbnailUrlString", json_schema_extra={"examples": ["https://example.com/products/files/httphandlers/filehandler.ashx?action=thumb&fileid={0}"]})
    confirm_delete: Optional[StrictBool] = Field(default=None, description="Specifies whether to confirm the file deletion or not.", alias="confirmDelete", json_schema_extra={"examples": [True]})
    enable_third_party: Optional[StrictBool] = Field(default=None, description="Specifies whether to allow users to connect the third-party storages.", alias="enableThirdParty", json_schema_extra={"examples": [True]})
    external_share: Optional[StrictBool] = Field(default=None, description="Specifies whether to enable sharing external links to the files.", alias="externalShare", json_schema_extra={"examples": [True]})
    external_share_social_media: Optional[StrictBool] = Field(default=None, description="Specifies whether to enable sharing files on social media.", alias="externalShareSocialMedia", json_schema_extra={"examples": [True]})
    store_original_files: Optional[StrictBool] = Field(default=None, description="Specifies whether to enable storing original files.", alias="storeOriginalFiles", json_schema_extra={"examples": [True]})
    keep_new_file_name: Optional[StrictBool] = Field(default=None, description="Specifies whether to keep the new file name.", alias="keepNewFileName", json_schema_extra={"examples": [False]})
    display_file_extension: Optional[StrictBool] = Field(default=None, description="Specifies whether to display the file extension.", alias="displayFileExtension", json_schema_extra={"examples": [True]})
    convert_notify: Optional[StrictBool] = Field(default=None, description="Specifies whether to display the conversion notification.", alias="convertNotify", json_schema_extra={"examples": [True]})
    hide_confirm_cancel_operation: Optional[StrictBool] = Field(default=None, description="Specifies whether to hide the confirmation dialog for the cancel operation.", alias="hideConfirmCancelOperation", json_schema_extra={"examples": [False]})
    ...
    favorites_section: Optional[StrictBool] = Field(default=None, description="Specifies if the Favorites section is displayed or not.", alias="favoritesSection", json_schema_extra={"examples": [True]})
    templates_section: Optional[StrictBool] = Field(default=None, description="Specifies if the Templates section is displayed or not.", alias="templatesSection", json_schema_extra={"examples": [True]})
    download_tar_gz: Optional[StrictBool] = Field(default=None, description="Specifies whether to download the .tar.gz files or not.", alias="downloadTarGz", json_schema_extra={"examples": [True]})
    automatically_clean_up: Optional[AutoCleanUpData] = Field(default=None, description="The auto-clearing setting parameters.", alias="automaticallyCleanUp")
    can_search_by_content: Optional[StrictBool] = Field(default=None, description="Specifies whether the file can be searched by its content or not.", alias="canSearchByContent", json_schema_extra={"examples": [True]})
    default_sharing_access_rights: Optional[List[StrictInt]] = Field(default=None, description="The default access rights in sharing settings.", alias="defaultSharingAccessRights", json_schema_extra={"examples": [[1, 2]]})
    max_upload_thread_count: Optional[StrictInt] = Field(default=None, description="The maximum number of upload threads.", alias="maxUploadThreadCount", json_schema_extra={"examples": [10]})
    chunk_upload_size: Optional[StrictInt] = Field(default=None, description="The size of a large file that is uploaded in chunks.", alias="chunkUploadSize", json_schema_extra={"examples": [10485760]})
    open_editor_in_same_tab: Optional[StrictBool] = Field(default=None, description="Specifies whether to open the editor in the same tab or not.", alias="openEditorInSameTab", json_schema_extra={"examples": [False]})
    organize_rooms_grouping: Optional[StrictBool] = Field(default=None, description="Specifies whether the grouping of rooms is enabled or not.", alias="organizeRoomsGrouping", json_schema_extra={"examples": [True]})
    default_share_link_internal: Optional[StrictBool] = Field(default=None, description="Specifies the default sharing link type: true = DocSpace users only (internal), false = Anyone with the link.", alias="defaultShareLinkInternal", json_schema_extra={"examples": [False]})
    ...
    exts_files_vectorized: Optional[List[StrictStr]] = Field(default=None, description="List of extensions available for vectorization", alias="extsFilesVectorized", json_schema_extra={"examples": [[".docx", ".pdf", ".txt"]]})
    max_vectorization_file_size: Optional[StrictInt] = Field(default=None, description="The maximum file size for vectorization", alias="maxVectorizationFileSize", json_schema_extra={"examples": [5242880]})
