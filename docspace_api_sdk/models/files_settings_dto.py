...
class FilesSettingsDto(BaseModel):
    ...
    default_share_link_internal: Optional[StrictBool] = Field(default=None, description="Specifies the default sharing link type: true = DocSpace users only (internal), false = Anyone with the link.", alias="defaultShareLinkInternal")
