...
class SmtpOperationStatusRequestsWrapper(BaseModel):
    """
    The successful API response containing the SmtpOperationStatusRequestsDto object.
    """ # noqa: E501
    response: Optional[SmtpOperationStatusRequestsDto] = Field(default=None, description="The SmtpOperationStatusRequestsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SmtpOperationStatusRequestsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
