...
class CustomerInfoWrapper(BaseModel):
    """
    The successful API response containing the CustomerInfoDto object.
    """ # noqa: E501
    response: Optional[CustomerInfoDto] = Field(default=None, description="The CustomerInfoDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CustomerInfoDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
