...
class AiPromptsMoveRequest(BaseModel):
    """
    AiPromptsMoveRequest
    """ # noqa: E501
    id: StrictStr = Field(description="Prompt id to move.")
    folder_id: Optional[StrictStr] = Field(description="Target folder id, or `null` for root.", alias="folderId")
