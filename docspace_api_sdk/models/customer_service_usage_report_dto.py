...
class CustomerServiceUsageReportDto(BaseModel):
    ...
    """ # noqa: E501
    collection: Optional[List[CustomerServiceUsageDto]] = Field(default=None, description="A collection of service usage statistics.")
    ...
    total_quantity: Optional[StrictInt] = Field(default=None, description="The total quantity of records in the report.", alias="totalQuantity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collection": [CustomerServiceUsageDto.from_dict(_item) for _item in obj["collection"]] if obj.get("collection") is not None else None,
