...
class DeleteServersRequestBody(BaseModel):
    """
    Parameters specifying which MCP servers to delete.
    """ # noqa: E501
    servers: Optional[List[UUID]] = Field(description="Set of unique identifiers of the MCP servers to permanently remove. All room associations and connection data will also be deleted.")
