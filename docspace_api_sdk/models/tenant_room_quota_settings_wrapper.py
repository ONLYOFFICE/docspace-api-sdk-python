...
class TenantRoomQuotaSettingsWrapper(BaseModel):
    """
    The successful API response containing the TenantRoomQuotaSettings object.
    """ # noqa: E501
    response: Optional[TenantRoomQuotaSettings] = Field(default=None, description="The TenantRoomQuotaSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantRoomQuotaSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
