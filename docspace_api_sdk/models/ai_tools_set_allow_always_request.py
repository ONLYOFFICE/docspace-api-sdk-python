...
class AiToolsSetAllowAlwaysRequest(BaseModel):
    """
    AiToolsSetAllowAlwaysRequest
    """ # noqa: E501
    server_type: StrictStr = Field(alias="serverType")
    tool_name: StrictStr = Field(alias="toolName")
    value: StrictBool = Field(description="Whether the tool is always allowed.")
    entity_id: Optional[StrictStr] = Field(default=None, alias="entityId")
    __properties: ClassVar[List[str]] = ["serverType", "toolName", "value", "entityId"]
