...
class McpToolDto(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(description="Name of the tool as reported by the MCP server.")
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether this tool is enabled (true) or disabled (false) for use in AI chat sessions within the room.")
