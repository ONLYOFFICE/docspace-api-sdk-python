...
class FolderIntegerWrapper(BaseModel):
    """
    The successful API response containing the FolderDtoInteger object.
    """ # noqa: E501
    response: Optional[FolderDtoInteger] = Field(default=None, description="The FolderDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FolderDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
