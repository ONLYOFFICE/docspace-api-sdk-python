...
class AiProviderWrapper(BaseModel):
    """
    AiProviderWrapper
    """ # noqa: E501
    response: Optional[AiProviderDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiProviderDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
