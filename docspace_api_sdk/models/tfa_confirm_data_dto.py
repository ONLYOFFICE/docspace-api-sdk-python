...
class TfaConfirmDataDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cookie_name (nullable) is None
        # and model_fields_set contains the field
        if self.cookie_name is None and "cookie_name" in self.model_fields_set:
            _dict['cookieName'] = None

        # set to None if cookie_value (nullable) is None
        # and model_fields_set contains the field
        if self.cookie_value is None and "cookie_value" in self.model_fields_set:
            _dict['cookieValue'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "cookieName": obj.get("cookieName"),
            "cookieValue": obj.get("cookieValue")
        })
        return _obj
