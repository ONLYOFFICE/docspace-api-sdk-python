...
class WebhooksConfigWrapper(BaseModel):
    """
    The successful API response containing the WebhooksConfigDto object.
    """ # noqa: E501
    response: Optional[WebhooksConfigDto] = Field(default=None, description="The WebhooksConfigDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": WebhooksConfigDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
