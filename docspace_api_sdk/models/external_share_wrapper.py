...
class ExternalShareWrapper(BaseModel):
    """
    The successful API response containing the ExternalShareDto object.
    """ # noqa: E501
    response: Optional[ExternalShareDto] = Field(default=None, description="The ExternalShareDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ExternalShareDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
