...
class BackupServiceStateWrapper(BaseModel):
    """
    The successful API response containing the BackupServiceStateDto object.
    """ # noqa: E501
    response: Optional[BackupServiceStateDto] = Field(default=None, description="The BackupServiceStateDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": BackupServiceStateDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
