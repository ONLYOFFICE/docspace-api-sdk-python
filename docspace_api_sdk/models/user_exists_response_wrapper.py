...
class UserExistsResponseWrapper(BaseModel):
    """
    The successful API response containing the UserExistsResponseDto object.
    """ # noqa: E501
    response: Optional[UserExistsResponseDto] = Field(default=None, description="The UserExistsResponseDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UserExistsResponseDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
