...
class XlsxReportResponseWrapper(BaseModel):
    """
    The successful API response containing the XlsxReportResponseDto object.
    """ # noqa: E501
    response: Optional[XlsxReportResponseDto] = Field(default=None, description="The XlsxReportResponseDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": XlsxReportResponseDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
