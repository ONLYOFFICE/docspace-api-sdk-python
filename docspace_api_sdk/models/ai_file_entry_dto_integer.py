...
class AiFileEntryDtoInteger(AiFileEntryBaseDto):
    """
    ...
    expiration_date: Optional[AiApiDateTime] = Field(default=None, description="Represents the expiration date of the file entry.", alias="expirationDate")
