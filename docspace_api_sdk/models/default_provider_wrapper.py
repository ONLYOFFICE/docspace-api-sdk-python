...
class DefaultProviderWrapper(BaseModel):
    """
    DefaultProviderWrapper
    """ # noqa: E501
    response: Optional[DefaultProviderDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DefaultProviderDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
