...
class FormSubmissionsWrapper(BaseModel):
    """
    The successful API response containing the FormSubmissionsDto object.
    """ # noqa: E501
    response: Optional[FormSubmissionsDto] = Field(default=None, description="The FormSubmissionsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FormSubmissionsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
