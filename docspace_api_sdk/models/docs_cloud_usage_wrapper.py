...
class DocsCloudUsageWrapper(BaseModel):
    """
    The successful API response containing the DocsCloudUsage object.
    """ # noqa: E501
    response: Optional[DocsCloudUsage] = Field(default=None, description="The DocsCloudUsage object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DocsCloudUsage.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
