...
class IpRestrictionsWrapper(BaseModel):
    """
    The successful API response containing the IpRestrictionsDto object.
    """ # noqa: E501
    response: Optional[IpRestrictionsDto] = Field(default=None, description="The IpRestrictionsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": IpRestrictionsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
