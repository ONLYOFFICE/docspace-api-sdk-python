...
class TenantWrapper(BaseModel):
    """
    The successful API response containing the TenantDto object.
    """ # noqa: E501
    response: Optional[TenantDto] = Field(default=None, description="The TenantDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
