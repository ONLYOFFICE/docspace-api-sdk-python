...
class GroupWrapper(BaseModel):
    """
    The successful API response containing the GroupDto object.
    """ # noqa: E501
    response: Optional[GroupDto] = Field(default=None, description="The GroupDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GroupDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
