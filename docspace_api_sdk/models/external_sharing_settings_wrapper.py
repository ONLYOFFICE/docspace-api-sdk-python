...
class ExternalSharingSettingsWrapper(BaseModel):
    """
    The successful API response containing the ExternalSharingSettingsDto object.
    """ # noqa: E501
    response: Optional[ExternalSharingSettingsDto] = Field(default=None, description="The ExternalSharingSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ExternalSharingSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
