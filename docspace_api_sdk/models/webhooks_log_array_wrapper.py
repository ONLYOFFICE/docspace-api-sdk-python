...
class WebhooksLogArrayWrapper(BaseModel):
    """
    The successful API response containing the list of WebhooksLogDto objects.
    """ # noqa: E501
    response: Optional[List[WebhooksLogDto]] = Field(default=None, description="The list of WebhooksLogDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [WebhooksLogDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
