...
class DocumentConfigDto(BaseModel):
    ...
    permissions: Optional[PermissionsConfig] = Field(default=None, description="The permissions configuration parameters.")
    ...
    options: Optional[Options] = Field(default=None, description="The document options.")
