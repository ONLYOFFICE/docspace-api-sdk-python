...
class AiPromptsUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Prompt id to update.")
    updates: AiPromptsUpdateRequestUpdates
    __properties: ClassVar[List[str]] = ["id", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "updates": AiPromptsUpdateRequestUpdates.from_dict(obj["updates"]) if obj.get("updates") is not None else None
        })
        return _obj
