...
class RoomFromTemplateStatusWrapper(BaseModel):
    """
    The successful API response containing the RoomFromTemplateStatusDto object.
    """ # noqa: E501
    response: Optional[RoomFromTemplateStatusDto] = Field(default=None, description="The RoomFromTemplateStatusDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": RoomFromTemplateStatusDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
