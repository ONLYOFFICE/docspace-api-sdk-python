...
class SsoSettingsV2Wrapper(BaseModel):
    """
    The successful API response containing the SsoSettingsV2 object.
    """ # noqa: E501
    response: Optional[SsoSettingsV2] = Field(default=None, description="The SsoSettingsV2 object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SsoSettingsV2.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
