...
class WalletServiceWrapper(BaseModel):
    """
    The successful API response containing the WalletServiceDto object.
    """ # noqa: E501
    response: Optional[WalletServiceDto] = Field(default=None, description="The WalletServiceDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": WalletServiceDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
