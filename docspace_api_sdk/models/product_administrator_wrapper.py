...
class ProductAdministratorWrapper(BaseModel):
    """
    The successful API response containing the ProductAdministratorDto object.
    """ # noqa: E501
    response: Optional[ProductAdministratorDto] = Field(default=None, description="The ProductAdministratorDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ProductAdministratorDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
