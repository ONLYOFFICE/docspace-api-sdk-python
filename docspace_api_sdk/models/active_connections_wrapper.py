...
class ActiveConnectionsWrapper(BaseModel):
    """
    The successful API response containing the ActiveConnectionsDto object.
    """ # noqa: E501
    response: Optional[ActiveConnectionsDto] = Field(default=None, description="The ActiveConnectionsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ActiveConnectionsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
