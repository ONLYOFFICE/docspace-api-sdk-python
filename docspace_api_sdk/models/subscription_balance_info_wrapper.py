...
class SubscriptionBalanceInfoWrapper(BaseModel):
    """
    The successful API response containing the SubscriptionBalanceInfo object.
    """ # noqa: E501
    response: Optional[SubscriptionBalanceInfo] = Field(default=None, description="The SubscriptionBalanceInfo object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SubscriptionBalanceInfo.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
