...
class WizardSettingsWrapper(BaseModel):
    """
    The successful API response containing the WizardSettings object.
    """ # noqa: E501
    response: Optional[WizardSettings] = Field(default=None, description="The WizardSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": WizardSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
