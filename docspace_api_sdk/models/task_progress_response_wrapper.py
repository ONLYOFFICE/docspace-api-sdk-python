...
class TaskProgressResponseWrapper(BaseModel):
    """
    The successful API response containing the TaskProgressResponseDto object.
    """ # noqa: E501
    response: Optional[TaskProgressResponseDto] = Field(default=None, description="The TaskProgressResponseDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TaskProgressResponseDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
