...
class PreviewProviderModelsRequestDto(BaseModel):
    """
    Request parameters for previewing models available from a provider before saving it.
    """ # noqa: E501
    type: Optional[ProviderType] = None
    url: Optional[StrictStr] = Field(default=None, description="The API endpoint URL. Required for OpenAiCompatible type; optional for other types that have default URLs.")
    key: Optional[StrictStr] = Field(description="The authentication API key for the AI provider.")
    __properties: ClassVar[List[str]] = ["type", "url", "key"]
