...
class RestrictedModelsResponseWrapper(BaseModel):
    """
    The successful API response containing the RestrictedModelsResponse object.
    """ # noqa: E501
    response: Optional[RestrictedModelsResponse] = Field(default=None, description="The RestrictedModelsResponse object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": RestrictedModelsResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
