...
class AiPricesResponseWrapper(BaseModel):
    """
    The successful API response containing the AiPricesResponse object.
    """ # noqa: E501
    response: Optional[AiPricesResponse] = Field(default=None, description="The AiPricesResponse object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiPricesResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
