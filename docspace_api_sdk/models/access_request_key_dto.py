...
class AccessRequestKeyDto(BaseModel):
    ...
    public_key_id: Optional[UUID] = Field(default=None, description="Public key ID", alias="publicKeyId")
    private_key_enc: Optional[StrictStr] = Field(default=None, description="Encrypted private key", alias="privateKeyEnc")
