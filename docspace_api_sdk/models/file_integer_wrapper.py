...
class FileIntegerWrapper(BaseModel):
    """
    The successful API response containing the FileDtoInteger object.
    """ # noqa: E501
    response: Optional[FileDtoInteger] = Field(default=None, description="The FileDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
