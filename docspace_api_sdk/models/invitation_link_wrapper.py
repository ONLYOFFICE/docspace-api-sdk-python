...
class InvitationLinkWrapper(BaseModel):
    """
    The successful API response containing the InvitationLinkDto object.
    """ # noqa: E501
    response: Optional[InvitationLinkDto] = Field(default=None, description="The InvitationLinkDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": InvitationLinkDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
