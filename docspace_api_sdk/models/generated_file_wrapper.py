...
class GeneratedFileWrapper(BaseModel):
    """
    GeneratedFileWrapper
    """ # noqa: E501
    response: Optional[GeneratedFileDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GeneratedFileDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
