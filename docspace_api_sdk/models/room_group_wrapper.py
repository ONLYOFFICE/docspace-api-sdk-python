...
class RoomGroupWrapper(BaseModel):
    """
    The successful API response containing the RoomGroupDto object.
    """ # noqa: E501
    response: Optional[RoomGroupDto] = Field(default=None, description="The RoomGroupDto object returned by the operation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoomGroupWrapper from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoomGroupWrapper from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": RoomGroupDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
