...
class AiAgentsDeleteRequest(BaseModel):
    """
    AiAgentsDeleteRequest
    """ # noqa: E501
    delete_after: Optional[StrictBool] = Field(default=None, description="Delete the room after the editing session finishes.", alias="deleteAfter")
