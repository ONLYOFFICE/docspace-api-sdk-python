...
class ConfirmWrapper(BaseModel):
    """
    The successful API response containing the ConfirmDto object.
    """ # noqa: E501
    response: Optional[ConfirmDto] = Field(default=None, description="The ConfirmDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ConfirmDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
