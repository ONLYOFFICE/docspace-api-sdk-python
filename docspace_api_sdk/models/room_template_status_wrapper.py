...
class RoomTemplateStatusWrapper(BaseModel):
    """
    The successful API response containing the RoomTemplateStatusDto object.
    """ # noqa: E501
    response: Optional[RoomTemplateStatusDto] = Field(default=None, description="The RoomTemplateStatusDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": RoomTemplateStatusDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
