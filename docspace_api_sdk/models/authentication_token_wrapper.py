...
class AuthenticationTokenWrapper(BaseModel):
    """
    The successful API response containing the AuthenticationTokenDto object.
    """ # noqa: E501
    response: Optional[AuthenticationTokenDto] = Field(default=None, description="The AuthenticationTokenDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AuthenticationTokenDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
