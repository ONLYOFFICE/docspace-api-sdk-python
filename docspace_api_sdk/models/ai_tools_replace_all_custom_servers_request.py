...
class AiToolsReplaceAllCustomServersRequest(BaseModel):
    """
    AiToolsReplaceAllCustomServersRequest
    """ # noqa: E501
    map: Dict[str, Dict[str, Any]] = Field(description="Full replacement set, keyed by server name.")
    entity_id: Optional[StrictStr] = Field(default=None, alias="entityId")
    __properties: ClassVar[List[str]] = ["map", "entityId"]
