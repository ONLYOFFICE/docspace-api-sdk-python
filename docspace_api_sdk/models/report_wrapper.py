...
class ReportWrapper(BaseModel):
    ...
    """ # noqa: E501
    response: Optional[ReportDto] = Field(default=None, description="The ReportDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ReportDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
