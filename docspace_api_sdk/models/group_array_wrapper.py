...
class GroupArrayWrapper(BaseModel):
    """
    The successful API response containing the list of GroupDto objects.
    """ # noqa: E501
    response: Optional[List[GroupDto]] = Field(default=None, description="The list of GroupDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [GroupDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
