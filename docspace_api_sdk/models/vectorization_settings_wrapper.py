...
class VectorizationSettingsWrapper(BaseModel):
    """
    VectorizationSettingsWrapper
    """ # noqa: E501
    response: Optional[VectorizationSettingsDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": VectorizationSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
