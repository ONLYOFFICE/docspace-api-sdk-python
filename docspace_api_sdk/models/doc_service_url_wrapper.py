...
class DocServiceUrlWrapper(BaseModel):
    """
    The successful API response containing the DocServiceUrlDto object.
    """ # noqa: E501
    response: Optional[DocServiceUrlDto] = Field(default=None, description="The DocServiceUrlDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DocServiceUrlDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
