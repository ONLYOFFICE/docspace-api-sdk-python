...
class AppWrapper(BaseModel):
    ...
    """ # noqa: E501
    response: Optional[AppDto] = Field(default=None, description="The AppDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AppDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
