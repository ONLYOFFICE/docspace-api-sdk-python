...
class UploadSessionResponseIntegerWrapper(BaseModel):
    """
    The successful API response containing the UploadSessionResponseDtoInteger object.
    """ # noqa: E501
    response: Optional[UploadSessionResponseDtoInteger] = Field(default=None, description="The UploadSessionResponseDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UploadSessionResponseDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
