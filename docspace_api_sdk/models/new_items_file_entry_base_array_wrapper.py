...
class NewItemsFileEntryBaseArrayWrapper(BaseModel):
    """
    The successful API response containing the list of NewItemsDtoFileEntryBaseDto objects.
    """ # noqa: E501
    response: Optional[List[NewItemsDtoFileEntryBaseDto]] = Field(default=None, description="The list of NewItemsDtoFileEntryBaseDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [NewItemsDtoFileEntryBaseDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
