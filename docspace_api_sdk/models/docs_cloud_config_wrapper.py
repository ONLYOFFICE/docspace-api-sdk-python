...
class DocsCloudConfigWrapper(BaseModel):
    """
    The successful API response containing the DocsCloudConfig object.
    """ # noqa: E501
    response: Optional[DocsCloudConfig] = Field(default=None, description="The DocsCloudConfig object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DocsCloudConfig.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
