...
class StorageArrayWrapper(BaseModel):
    """
    The successful API response containing the list of StorageDto objects.
    """ # noqa: E501
    response: Optional[List[StorageDto]] = Field(default=None, description="The list of StorageDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [StorageDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
