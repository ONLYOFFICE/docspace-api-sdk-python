...
class AddRoomServersRequestBody(BaseModel):
    """
    Parameters specifying which MCP servers to assign to the room.
    """ # noqa: E501
    servers: Optional[List[UUID]] = Field(description="Set of unique identifiers of MCP servers to associate with the room. A maximum of 5 servers can be assigned per room.")
