...
class FileShareWrapper(BaseModel):
    """
    The successful API response containing the FileShareDto object.
    """ # noqa: E501
    response: Optional[FileShareDto] = Field(default=None, description="The FileShareDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FileShareDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
