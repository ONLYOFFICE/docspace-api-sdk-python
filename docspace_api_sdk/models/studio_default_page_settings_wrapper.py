...
class StudioDefaultPageSettingsWrapper(BaseModel):
    """
    The successful API response containing the StudioDefaultPageSettings object.
    """ # noqa: E501
    response: Optional[StudioDefaultPageSettings] = Field(default=None, description="The StudioDefaultPageSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": StudioDefaultPageSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
