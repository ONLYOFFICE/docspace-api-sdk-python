...
class UpcomingPaymentDto(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The quota name.")
    title: Optional[StrictStr] = Field(default=None, description="The quota title.")
    unit_of_measure: Optional[StrictStr] = Field(default=None, description="The quota unit of measure.", alias="unitOfMeasure")
    quantity: Optional[StrictInt] = Field(default=None, description="The quantity that will be charged (the next quantity if set, otherwise the current quantity).")
    wallet: Optional[StrictBool] = Field(default=None, description="The quota applies to the wallet or not.")
    due_date: Optional[ApiDateTime] = Field(default=None, alias="dueDate")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount that will be charged (unit price multiplied by the quantity).")
    currency: Optional[StrictStr] = Field(default=None, description="The three-character ISO 4217 currency symbol of the amount.")
