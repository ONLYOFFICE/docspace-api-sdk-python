...
class UpdateRoomsQuotaRequestDtoInteger(BaseModel):
    ...
    """ # noqa: E501
    room_ids: Optional[List[DuplicateRequestDtoAllOfFileIds]] = Field(default=None, description="The list of room IDs.", alias="roomIds", json_schema_extra={"examples": [[1, 2, 3]]})
