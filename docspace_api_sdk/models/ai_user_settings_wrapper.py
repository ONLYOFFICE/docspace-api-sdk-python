...
class AiUserSettingsWrapper(BaseModel):
    """
    AiUserSettingsWrapper
    """ # noqa: E501
    response: Optional[AiUserSettingsDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiUserSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
