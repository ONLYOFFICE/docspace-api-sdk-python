...
class ConnectionTestResultWrapper(BaseModel):
    """
    The successful API response containing the ConnectionTestResult object.
    """ # noqa: E501
    response: Optional[ConnectionTestResult] = Field(default=None, description="The ConnectionTestResult object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ConnectionTestResult.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
