...
class EncryptionKeyWrapper(BaseModel):
    """
    EncryptionKeyWrapper
    """ # noqa: E501
    response: Optional[EncryptionKeyDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": EncryptionKeyDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
