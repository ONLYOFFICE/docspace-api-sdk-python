...
class CheckDestFolderWrapper(BaseModel):
    """
    The successful API response containing the CheckDestFolderDto object.
    """ # noqa: E501
    response: Optional[CheckDestFolderDto] = Field(default=None, description="The CheckDestFolderDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CheckDestFolderDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
