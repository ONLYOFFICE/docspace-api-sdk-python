...
class PaymentSettingsWrapper(BaseModel):
    """
    The successful API response containing the PaymentSettingsDto object.
    """ # noqa: E501
    response: Optional[PaymentSettingsDto] = Field(default=None, description="The PaymentSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": PaymentSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
