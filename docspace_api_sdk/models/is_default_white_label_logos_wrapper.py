...
class IsDefaultWhiteLabelLogosWrapper(BaseModel):
    """
    The successful API response containing the IsDefaultWhiteLabelLogosDto object.
    """ # noqa: E501
    response: Optional[IsDefaultWhiteLabelLogosDto] = Field(default=None, description="The IsDefaultWhiteLabelLogosDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": IsDefaultWhiteLabelLogosDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
