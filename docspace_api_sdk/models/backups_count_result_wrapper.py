...
class BackupsCountResultWrapper(BaseModel):
    """
    The successful API response containing the BackupsCountResultDto object.
    """ # noqa: E501
    response: Optional[BackupsCountResultDto] = Field(default=None, description="The BackupsCountResultDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": BackupsCountResultDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
