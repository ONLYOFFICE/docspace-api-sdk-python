...
class AiAiSettingsWrapper(BaseModel):
    """
    The successful API response containing the AiSettingsDto object.
    """ # noqa: E501
    response: Optional[AiAiSettingsDto] = Field(default=None, description="The AiSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiAiSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
