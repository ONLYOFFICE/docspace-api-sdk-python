...
class DocsCloudLicenseInfo(BaseModel):
    ...
    build_date: Optional[datetime] = Field(default=None, description="The license build date.", alias="buildDate", json_schema_extra={"examples": ["2024-01-15T10:30:00Z"]})
    __properties: ClassVar[List[str]] = ["valid", "trial", "buildDate"]
