...
class AiPromptsImportBundleRequest(BaseModel):
    """
    AiPromptsImportBundleRequest
    """ # noqa: E501
    bundle: AiPromptBundle = Field(description="Bundle to restore.")
    options: Optional[AiPromptsImportBundleRequestOptions] = None
    __properties: ClassVar[List[str]] = ["bundle", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bundle": AiPromptBundle.from_dict(obj["bundle"]) if obj.get("bundle") is not None else None,
            "options": AiPromptsImportBundleRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
