...
class TenantWalletSettingsWrapper(BaseModel):
    ...
    """ # noqa: E501
    settings: Optional[TenantWalletSettings] = Field(default=None, description="The tenant wallet settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": TenantWalletSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
