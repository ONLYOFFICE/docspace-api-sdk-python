...
class ChatMultimodalSettingsDto(BaseModel):
    """
    The multimodal settings for the chat model.
    """ # noqa: E501
    image: Optional[ChatImageMultimodalSettingsDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": ChatImageMultimodalSettingsDto.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
