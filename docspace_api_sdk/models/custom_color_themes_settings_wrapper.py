...
class CustomColorThemesSettingsWrapper(BaseModel):
    """
    The successful API response containing the CustomColorThemesSettingsDto object.
    """ # noqa: E501
    response: Optional[CustomColorThemesSettingsDto] = Field(default=None, description="The CustomColorThemesSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CustomColorThemesSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
