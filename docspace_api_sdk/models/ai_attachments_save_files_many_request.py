...
class AiAttachmentsSaveFilesManyRequest(BaseModel):
    """
    AiAttachmentsSaveFilesManyRequest
    """ # noqa: E501
    inputs: List[AiAttachmentsSaveFileRequestInput]
    entity_id: Optional[StrictStr] = Field(default=None, alias="entityId")
    __properties: ClassVar[List[str]] = ["inputs", "entityId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": [AiAttachmentsSaveFileRequestInput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
