...
class DeleteRoomServersRequestBody(BaseModel):
    """
    Parameters specifying which MCP servers to detach from the room.
    """ # noqa: E501
    servers: Optional[List[UUID]] = Field(description="Set of unique identifiers of MCP servers to remove from the room. Associated connections and tool configurations will also be cleaned up.")
