...
class FolderStringWrapper(BaseModel):
    """
    The successful API response containing the FolderDtoString object.
    """ # noqa: E501
    response: Optional[FolderDtoString] = Field(default=None, description="The FolderDtoString object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FolderDtoString.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
