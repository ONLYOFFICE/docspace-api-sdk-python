...
class AiFileOperationDto(BaseModel):
    """
    ...
    operation: AiFileOperationType = Field(description="The file operation type.", alias="Operation")
    ...
    files: Optional[List[AiFileEntryBaseDto]] = Field(default=None, description="The list of files of the file operation.", json_schema_extra={"examples": [[{"id": 10, "title": "document.docx"}]]})
    folders: Optional[List[AiFileEntryBaseDto]] = Field(default=None, description="The list of folders of the file operation.", json_schema_extra={"examples": [[{"id": 20, "title": "My Folder"}]]})
    status: Optional[AiDistributedTaskStatus] = Field(default=None, description="The status of the distributed task related to the file operation.")
