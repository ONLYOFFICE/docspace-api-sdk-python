...
class DefaultTemplateSettingsRequestDto(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of selected_file
        if self.selected_file:
            _dict['selectedFile'] = self.selected_file.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selectedFile": DefaultTemplateSettingsRequestDtoSelectedFile.from_dict(obj["selectedFile"]) if obj.get("selectedFile") is not None else None,
