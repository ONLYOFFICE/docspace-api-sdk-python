...
from docspace_api_sdk.models.file_dto_integer_view_accessibility import FileDtoIntegerViewAccessibility
...
class FileDtoInteger(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "access", "sharedBy", "ownedBy", "shared", "sharedForUser", "parentShared", "shortWebUrl", "created", "createdBy", "updated", "autoDelete", "rootFolderType", "parentRoomType", "updatedBy", "providerItem", "providerKey", "providerId", "order", "isFavorite", "id", "rootFolderId", "originId", "originRoomId", "originTitle", "originRoomTitle", "canShare", "shareSettings", "security", "availableShareRights", "requestToken", "external", "expirationDate", "isLinkExpired", "folderId", "version", "versionGroup", "contentLength", "pureContentLength", "fileStatus", "editingBy", "mute", "viewUrl", "webUrl", "fileType", "fileExst", "comment", "encrypted", "thumbnailUrl", "thumbnailStatus", "locked", "lockedBy", "hasDraft", "formFillingStatus", "isForm", "customFilterEnabled", "customFilterEnabledBy", "startFilling", "isFillingPreparing", "inProcessFolderId", "inProcessFolderTitle", "draftLocation", "viewAccessibility", "lastOpened", "expired", "fileEntryType", "vectorizationStatus", "dimensions"]
