...
class QuotaArrayWrapper(BaseModel):
    """
    The successful API response containing the list of QuotaDto objects.
    """ # noqa: E501
    response: Optional[List[QuotaDto]] = Field(default=None, description="The list of QuotaDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [QuotaDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
