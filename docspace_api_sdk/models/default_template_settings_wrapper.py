...
class DefaultTemplateSettingsWrapper(BaseModel):
    """
    The successful API response containing the DefaultTemplateSettingsDto object.
    """ # noqa: E501
    response: Optional[DefaultTemplateSettingsDto] = Field(default=None, description="The DefaultTemplateSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DefaultTemplateSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
