...
class TenantAiAccessSettingsWrapper(BaseModel):
    """
    The successful API response containing the TenantAiAccessSettings object.
    """ # noqa: E501
    response: Optional[TenantAiAccessSettings] = Field(default=None, description="The TenantAiAccessSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantAiAccessSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
