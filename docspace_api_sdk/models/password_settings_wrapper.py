...
class PasswordSettingsWrapper(BaseModel):
    """
    The successful API response containing the PasswordSettingsDto object.
    """ # noqa: E501
    response: Optional[PasswordSettingsDto] = Field(default=None, description="The PasswordSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": PasswordSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
