...
class CapabilitiesWrapper(BaseModel):
    """
    The successful API response containing the CapabilitiesDto object.
    """ # noqa: E501
    response: Optional[CapabilitiesDto] = Field(default=None, description="The CapabilitiesDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CapabilitiesDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
