...
class ApiKeyResponseWrapper(BaseModel):
    """
    The successful API response containing the ApiKeyResponseDto object.
    """ # noqa: E501
    response: Optional[ApiKeyResponseDto] = Field(default=None, description="The ApiKeyResponseDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ApiKeyResponseDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
