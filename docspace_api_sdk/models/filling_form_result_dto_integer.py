...
class FillingFormResultDtoInteger(BaseModel):
    ...
    completed_form: Optional[FileDtoInteger] = Field(default=None, description="The file with the completed forms.", alias="completedForm")
    original_form: Optional[FileDtoInteger] = Field(default=None, description="The file with the original forms.", alias="originalForm")
    manager: Optional[EmployeeFullDto] = Field(default=None, description="The manager who is filling the form.")
