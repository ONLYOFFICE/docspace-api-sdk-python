...
class BackupsCountResultDto(BaseModel):
    ...
    """ # noqa: E501
    free: Optional[StrictInt] = Field(default=None, description="The number of free backups.")
    paid: Optional[StrictInt] = Field(default=None, description="The number of paid backups.")
