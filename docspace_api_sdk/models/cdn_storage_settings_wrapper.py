...
class CdnStorageSettingsWrapper(BaseModel):
    """
    The successful API response containing the CdnStorageSettings object.
    """ # noqa: E501
    response: Optional[CdnStorageSettings] = Field(default=None, description="The CdnStorageSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CdnStorageSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
