...
class CustomerServiceUsageReportWrapper(BaseModel):
    """
    The successful API response containing the CustomerServiceUsageReportDto object.
    """ # noqa: E501
    response: Optional[CustomerServiceUsageReportDto] = Field(default=None, description="The CustomerServiceUsageReportDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CustomerServiceUsageReportDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
