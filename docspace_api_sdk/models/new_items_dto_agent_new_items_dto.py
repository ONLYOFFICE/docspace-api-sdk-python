...
class NewItemsDtoAgentNewItemsDto(BaseModel):
    """
    The new item parameters.
    """ # noqa: E501
    var_date: ApiDateTime = Field(alias="date")
    items: Optional[List[AgentNewItemsDto]] = Field(description="The list of items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AgentNewItemsDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
