...
class RoomSecurityWrapper(BaseModel):
    """
    The successful API response containing the RoomSecurityDto object.
    """ # noqa: E501
    response: Optional[RoomSecurityDto] = Field(default=None, description="The RoomSecurityDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": RoomSecurityDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
