...
class EditHistoryDataWrapper(BaseModel):
    """
    The successful API response containing the EditHistoryDataDto object.
    """ # noqa: E501
    response: Optional[EditHistoryDataDto] = Field(default=None, description="The EditHistoryDataDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": EditHistoryDataDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
