...
class FileOperationArrayWrapper(BaseModel):
    """
    The successful API response containing the list of FileOperationDto objects.
    """ # noqa: E501
    response: Optional[List[FileOperationDto]] = Field(default=None, description="The list of FileOperationDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [FileOperationDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
