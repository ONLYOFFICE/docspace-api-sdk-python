...
class TelegramStatusWrapper(BaseModel):
    """
    The successful API response containing the TelegramStatusDto object.
    """ # noqa: E501
    response: Optional[TelegramStatusDto] = Field(default=None, description="The TelegramStatusDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TelegramStatusDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
