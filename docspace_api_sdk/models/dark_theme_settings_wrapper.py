...
class DarkThemeSettingsWrapper(BaseModel):
    """
    The successful API response containing the DarkThemeSettings object.
    """ # noqa: E501
    response: Optional[DarkThemeSettings] = Field(default=None, description="The DarkThemeSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DarkThemeSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
