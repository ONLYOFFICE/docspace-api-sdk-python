...
class AiThreadsAppendUserMessageRequest(BaseModel):
    """
    AiThreadsAppendUserMessageRequest
    """ # noqa: E501
    thread_id: StrictStr = Field(alias="threadId")
    message: AiThreadMessageLike = Field(description="Message to persist (id/createdAt are storage-assigned).")
    profile_id: Optional[StrictStr] = Field(default=None, alias="profileId")
    __properties: ClassVar[List[str]] = ["threadId", "message", "profileId"]
