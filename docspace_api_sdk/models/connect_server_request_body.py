...
class ConnectServerRequestBody(BaseModel):
    """
    Parameters for completing an OAuth connection to an MCP server.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(description="OAuth authorization code received from the provider's redirect. Used to exchange for access and refresh tokens.")
