...
class FileDtoString(FileEntryDtoString):
    """
    The file parameters.
    """

    folder_id: Optional[StrictStr] = Field(default=None, description="The folder ID where the file is located.", alias="folderId")
    ...
    draft_location: Optional[DraftLocationString] = Field(default=None, alias="draftLocation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        extra_fields = cls.model_validate({
            ...
            "draftLocation": DraftLocationString.from_dict(obj["draftLocation"]) if obj.get("draftLocation") is not None else None,
