...
class WalletServiceArrayWrapper(BaseModel):
    """
    The successful API response containing the list of WalletServiceDto objects.
    """ # noqa: E501
    response: Optional[List[WalletServiceDto]] = Field(default=None, description="The list of WalletServiceDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [WalletServiceDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
