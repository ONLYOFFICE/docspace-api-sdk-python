...
class ChunkedUploadSessionResponseWrapperInteger(BaseModel):
    """
    ...
    data: Optional[ChunkedUploadSessionResponseInteger] = Field(default=None, description="Gets or sets the data of the chunked upload session response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ChunkedUploadSessionResponseInteger.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
