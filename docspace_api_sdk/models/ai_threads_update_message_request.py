...
class AiThreadsUpdateMessageRequest(BaseModel):
    """
    AiThreadsUpdateMessageRequest
    """ # noqa: E501
    message_id: StrictStr = Field(alias="messageId")
    message: AiThreadMessageLike = Field(description="Replacement message content.")
    __properties: ClassVar[List[str]] = ["messageId", "message"]
