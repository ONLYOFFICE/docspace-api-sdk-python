...
class AdditionalWhiteLabelSettingsDtoWrapper(BaseModel):
    """
    The successful API response containing the AdditionalWhiteLabelSettingsDto object.
    """ # noqa: E501
    response: Optional[AdditionalWhiteLabelSettingsDto] = Field(default=None, description="The AdditionalWhiteLabelSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AdditionalWhiteLabelSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
