...
class TenantQuotaSettingsWrapper(BaseModel):
    """
    The successful API response containing the TenantQuotaSettings object.
    """ # noqa: E501
    response: Optional[TenantQuotaSettings] = Field(default=None, description="The TenantQuotaSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantQuotaSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
