...
class DocsCloudStats(BaseModel):
    ...
    viewer: Optional[DocsCloudUserStats] = Field(default=None, description="The statistics for viewer users.")
    __properties: ClassVar[List[str]] = ["periodDay", "editor", "viewer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editor": DocsCloudUserStats.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
            "viewer": DocsCloudUserStats.from_dict(obj["viewer"]) if obj.get("viewer") is not None else None
        })
        return _obj
