...
class EmployeeFullArrayWrapper(BaseModel):
    """
    The successful API response containing the list of EmployeeFullDto objects.
    """ # noqa: E501
    response: Optional[List[EmployeeFullDto]] = Field(default=None, description="The list of EmployeeFullDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [EmployeeFullDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
