...
class TenantDeepLinkSettingsWrapper(BaseModel):
    """
    The successful API response containing the TenantDeepLinkSettings object.
    """ # noqa: E501
    response: Optional[TenantDeepLinkSettings] = Field(default=None, description="The TenantDeepLinkSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantDeepLinkSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
