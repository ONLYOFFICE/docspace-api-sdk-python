...
class NewItemsRoomNewItemsArrayWrapper(BaseModel):
    """
    The successful API response containing the list of NewItemsDtoRoomNewItemsDto objects.
    """ # noqa: E501
    response: Optional[List[NewItemsDtoRoomNewItemsDto]] = Field(default=None, description="The list of NewItemsDtoRoomNewItemsDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [NewItemsDtoRoomNewItemsDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
