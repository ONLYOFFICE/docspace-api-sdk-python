...
class ChatDto(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="The unique identifier of the AI chat session.")
    title: Optional[StrictStr] = Field(default=None, description="The display title of the chat session.")
    created_on: Optional[ApiDateTime] = Field(default=None, alias="createdOn")
    modified_on: Optional[ApiDateTime] = Field(default=None, alias="modifiedOn")
    created_by: Optional[EmployeeDto] = Field(default=None, alias="createdBy")
    __properties: ClassVar[List[str]] = ["id", "title", "createdOn", "modifiedOn", "createdBy"]
