...
class AiThreadsRegenerateTitleRequest(BaseModel):
    """
    AiThreadsRegenerateTitleRequest
    """ # noqa: E501
    thread_id: StrictStr = Field(alias="threadId")
    profile: AiProfile = Field(description="Profile used to regenerate the title.")
    entity_meta: Optional[AiThreadsOpenOrCreateRequestEntityMeta] = Field(default=None, alias="entityMeta")
    __properties: ClassVar[List[str]] = ["threadId", "profile", "entityMeta"]
