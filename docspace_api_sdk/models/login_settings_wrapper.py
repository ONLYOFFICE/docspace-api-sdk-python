...
class LoginSettingsWrapper(BaseModel):
    """
    The successful API response containing the LoginSettingsDto object.
    """ # noqa: E501
    response: Optional[LoginSettingsDto] = Field(default=None, description="The LoginSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": LoginSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
