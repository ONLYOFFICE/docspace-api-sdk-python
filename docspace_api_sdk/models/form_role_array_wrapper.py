...
class FormRoleArrayWrapper(BaseModel):
    """
    The successful API response containing the list of FormRoleDto objects.
    """ # noqa: E501
    response: Optional[List[FormRoleDto]] = Field(default=None, description="The list of FormRoleDto objects returned by the operation.")
