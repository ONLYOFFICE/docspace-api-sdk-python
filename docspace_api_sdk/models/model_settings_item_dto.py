...
class ModelSettingsItemDto(BaseModel):
    """
    A single model settings entry within a provider create or update request.
    """ # noqa: E501
    model_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The model identifier.", alias="modelId")
    is_enabled: Optional[StrictBool] = Field(default=None, description="Whether the model is enabled for use in chat.", alias="isEnabled")
    alias: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The display name for the model. Only applies to non-recommended models.")
    capabilities: Optional[AiModelCapabilities] = None
    __properties: ClassVar[List[str]] = ["modelId", "isEnabled", "alias", "capabilities"]
