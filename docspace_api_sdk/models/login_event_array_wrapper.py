...
class LoginEventArrayWrapper(BaseModel):
    """
    The successful API response containing the list of LoginEventDto objects.
    """ # noqa: E501
    response: Optional[List[LoginEventDto]] = Field(default=None, description="The list of LoginEventDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [LoginEventDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
