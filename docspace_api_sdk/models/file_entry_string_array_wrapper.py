...
class FileEntryStringArrayWrapper(BaseModel):
    """
    FileEntryStringArrayWrapper
    """ # noqa: E501
    response: Optional[List[FileEntryDtoString]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [FileEntryDtoString.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
