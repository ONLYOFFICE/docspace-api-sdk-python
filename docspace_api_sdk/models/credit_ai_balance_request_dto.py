...
class CreditAiBalanceRequestDto(BaseModel):
    """
    The request parameters for crediting AI quota to the customer AI subaccount.
    """ # noqa: E501
    amount: Optional[Union[Annotated[float, Field(le=999999, strict=True, ge=0.01)], Annotated[int, Field(le=999999, strict=True, ge=1)]]] = Field(default=None, description="The amount to transfer from the main balance to the AI subaccount.")
