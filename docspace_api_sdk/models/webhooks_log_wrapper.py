...
class WebhooksLogWrapper(BaseModel):
    """
    The successful API response containing the WebhooksLogDto object.
    """ # noqa: E501
    response: Optional[WebhooksLogDto] = Field(default=None, description="The WebhooksLogDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": WebhooksLogDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
