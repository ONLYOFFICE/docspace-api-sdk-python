...
class TfaSetupCodeWrapper(BaseModel):
    """
    The successful API response containing the TfaSetupCodeDto object.
    """ # noqa: E501
    response: Optional[TfaSetupCodeDto] = Field(default=None, description="The TfaSetupCodeDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TfaSetupCodeDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
