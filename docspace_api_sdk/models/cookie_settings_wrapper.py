...
class CookieSettingsWrapper(BaseModel):
    """
    The successful API response containing the CookieSettingsDto object.
    """ # noqa: E501
    response: Optional[CookieSettingsDto] = Field(default=None, description="The CookieSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CookieSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
