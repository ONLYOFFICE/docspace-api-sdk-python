...
class ConfigurationIntegerWrapper(BaseModel):
    """
    The successful API response containing the ConfigurationDtoInteger object.
    """ # noqa: E501
    response: Optional[ConfigurationDtoInteger] = Field(default=None, description="The ConfigurationDtoInteger object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ConfigurationDtoInteger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
