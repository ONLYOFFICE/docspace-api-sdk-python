...
class UploadResultWrapper(BaseModel):
    """
    The successful API response containing the UploadResultDto object.
    """ # noqa: E501
    response: Optional[UploadResultDto] = Field(default=None, description="The UploadResultDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UploadResultDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
