...
class DocumentBuilderTaskWrapper(BaseModel):
    """
    The successful API response containing the DocumentBuilderTaskDto object.
    """ # noqa: E501
    response: Optional[DocumentBuilderTaskDto] = Field(default=None, description="The DocumentBuilderTaskDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DocumentBuilderTaskDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
