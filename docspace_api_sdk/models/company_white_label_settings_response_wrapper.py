...
class CompanyWhiteLabelSettingsResponseWrapper(BaseModel):
    """
    The successful API response containing the CompanyWhiteLabelSettings object.
    """ # noqa: E501
    response: Optional[CompanyWhiteLabelSettings] = Field(default=None, description="The CompanyWhiteLabelSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": CompanyWhiteLabelSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
