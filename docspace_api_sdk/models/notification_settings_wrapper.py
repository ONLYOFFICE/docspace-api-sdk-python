...
class NotificationSettingsWrapper(BaseModel):
    """
    The successful API response containing the NotificationSettingsDto object.
    """ # noqa: E501
    response: Optional[NotificationSettingsDto] = Field(default=None, description="The NotificationSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": NotificationSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
