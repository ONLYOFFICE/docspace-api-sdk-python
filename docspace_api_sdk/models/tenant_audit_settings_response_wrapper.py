...
class TenantAuditSettingsResponseWrapper(BaseModel):
    """
    The successful API response containing the TenantAuditSettings object.
    """ # noqa: E501
    response: Optional[TenantAuditSettings] = Field(default=None, description="The TenantAuditSettings object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TenantAuditSettings.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
