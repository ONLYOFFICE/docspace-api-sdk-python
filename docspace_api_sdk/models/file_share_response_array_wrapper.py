...
class FileShareResponseArrayWrapper(BaseModel):
    """
    The successful API response containing the list of FileShare objects.
    """ # noqa: E501
    response: Optional[List[FileShare]] = Field(default=None, description="The list of FileShare objects returned by the operation.")
