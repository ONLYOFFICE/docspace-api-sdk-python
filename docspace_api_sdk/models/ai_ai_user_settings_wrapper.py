...
class AiAiUserSettingsWrapper(BaseModel):
    """
    The successful API response containing the AiUserSettingsDto object.
    """ # noqa: E501
    response: Optional[AiAiUserSettingsDto] = Field(default=None, description="The AiUserSettingsDto object returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": AiAiUserSettingsDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
