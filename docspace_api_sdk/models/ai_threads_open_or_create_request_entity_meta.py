...
class AiThreadsOpenOrCreateRequestEntityMeta(BaseModel):
    """
    ...
    entity_title: Optional[StrictStr] = Field(default=None, alias="entityTitle")
    __properties: ClassVar[List[str]] = ["entityId", "entityTitle"]
