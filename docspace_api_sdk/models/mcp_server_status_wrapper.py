...
class McpServerStatusWrapper(BaseModel):
    """
    McpServerStatusWrapper
    """ # noqa: E501
    response: Optional[McpServerStatusDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": McpServerStatusDto.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "count": obj.get("count"),
