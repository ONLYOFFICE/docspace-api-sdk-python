...
class FolderContentIntegerArrayWrapper(BaseModel):
    """
    The successful API response containing the list of FolderContentDtoInteger objects.
    """ # noqa: E501
    response: Optional[List[FolderContentDtoInteger]] = Field(default=None, description="The list of FolderContentDtoInteger objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [FolderContentDtoInteger.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
