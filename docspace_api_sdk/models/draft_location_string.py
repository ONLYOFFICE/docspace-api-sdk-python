...
class DraftLocationString(BaseModel):
    """
    The file draft parameters.
    """ # noqa: E501
    folder_id: Optional[StrictStr] = Field(default=None, description="The InProcess folder ID of the draft.", alias="folderId")
    folder_title: Optional[StrictStr] = Field(default=None, description="The InProcess folder title of the draft.", alias="folderTitle")
    file_id: Optional[StrictStr] = Field(default=None, description="The draft ID.", alias="fileId")
