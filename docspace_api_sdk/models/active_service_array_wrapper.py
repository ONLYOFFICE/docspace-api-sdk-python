...
class ActiveServiceArrayWrapper(BaseModel):
    """
    The successful API response containing the list of ActiveServiceDto objects.
    """ # noqa: E501
    response: Optional[List[ActiveServiceDto]] = Field(default=None, description="The list of ActiveServiceDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [ActiveServiceDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
