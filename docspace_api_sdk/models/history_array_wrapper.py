...
class HistoryArrayWrapper(BaseModel):
    """
    The successful API response containing the list of HistoryDto objects.
    """ # noqa: E501
    response: Optional[List[HistoryDto]] = Field(default=None, description="The list of HistoryDto objects returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [HistoryDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "count": obj.get("count"),
