...
class BackupApi:
    ...
    def get_backups_counts(
        ...
        _param = self._get_backups_counts_serialize(
            var_from=var_from,
            to=to,
            paid=paid,
            _request_auth=_request_auth,
    ...
    def _get_backups_counts_serialize(
        self,
        var_from,
        to,
        paid,
        ...
        resource_path = "/api/2.0/backup/getbackupscountbypaid"
