...
class SearchApi:
    ...
    def get_groups_with_files_shared(
        ...
        _param = self._get_groups_with_files_shared_serialize(
            id=id,
    ...
    def _get_groups_with_files_shared_serialize(
        self,
        id,
        exclude_shared,
        count,
    ...
    def get_groups_with_folders_shared(
        ...
        _param = self._get_groups_with_folders_shared_serialize(
            id=id,
            exclude_shared=exclude_shared,
            count=count,
            start_index=start_index,
    ...
    def _get_groups_with_folders_shared_serialize(
        self,
        id,
        exclude_shared,
        count,
    ...
    def get_groups_with_rooms_shared(
        ...
        _param = self._get_groups_with_rooms_shared_serialize(
            id=id,
            exclude_shared=exclude_shared,
            count=count,
            start_index=start_index,
