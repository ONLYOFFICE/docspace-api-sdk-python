...
class MessagesApi:
    ...
    def export_message(
        self,
        message_id: Annotated[StrictInt, Field(description="The unique identifier of the AI chat message to export.")],
    ...
    def _export_message_serialize(
        ...
        resource_path = "/api/2.0/ai/messages/{messageId}/export"
