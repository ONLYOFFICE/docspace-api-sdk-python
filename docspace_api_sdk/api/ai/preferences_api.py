...
class PreferencesApi:
    ...
    def ai_preferences_clear_deep_mode(
        ...
        _param = self._ai_preferences_clear_deep_mode_serialize(
            body=body,
    ...
    def _ai_preferences_clear_deep_mode_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        resource_path = "/api/2.0/ai/preferences/clear-deep-mode"
    ...
    def ai_preferences_get_deep_mode(
        ...
        _param = self._ai_preferences_get_deep_mode_serialize(
            entity_id=entity_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _ai_preferences_get_deep_mode_serialize(
        self,
        entity_id,
        _request_auth,
        _content_type,
    ...
    def ai_preferences_is_deep_mode_set(
        ...
        _param = self._ai_preferences_is_deep_mode_set_serialize(
            entity_id=entity_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _ai_preferences_is_deep_mode_set_serialize(
        self,
        entity_id,
        _request_auth,
        _content_type,
        ...
        resource_path = "/api/2.0/ai/preferences/is-deep-mode-set"
    ...
    @validate_call
    def ai_preferences_set_deep_mode(
        self,
        ai_preferences_set_deep_mode_request: AiPreferencesSetDeepModeRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ai_preferences_set_deep_mode_serialize(
            ai_preferences_set_deep_mode_request=ai_preferences_set_deep_mode_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def ai_preferences_set_deep_mode_with_http_info(
        self,
        ai_preferences_set_deep_mode_request: AiPreferencesSetDeepModeRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ai_preferences_set_deep_mode_without_preload_content(
        self,
        ai_preferences_set_deep_mode_request: AiPreferencesSetDeepModeRequest,
        _request_timeout: Union[
            None,
    ...
    def _ai_preferences_set_deep_mode_serialize(
        self,
        ai_preferences_set_deep_mode_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ai_preferences_set_deep_mode_request is not None:
            _body_params = ai_preferences_set_deep_mode_request
