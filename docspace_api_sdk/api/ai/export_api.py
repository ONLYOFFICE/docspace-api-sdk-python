...
class ExportApi:
    ...
    @validate_call
    def ai_export_text_to_docx(
        self,
        ai_export_text_to_docx_request: AiExportTextToDocxRequest,
        ...
        _param = self._ai_export_text_to_docx_serialize(
            ai_export_text_to_docx_request=ai_export_text_to_docx_request,
    ...
    @validate_call
    def ai_export_text_to_docx_with_http_info(
        self,
        ai_export_text_to_docx_request: AiExportTextToDocxRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ai_export_text_to_docx_without_preload_content(
        self,
        ai_export_text_to_docx_request: AiExportTextToDocxRequest,
        _request_timeout: Union[
            None,
    ...
    def _ai_export_text_to_docx_serialize(
        self,
        ai_export_text_to_docx_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if ai_export_text_to_docx_request is not None:
            _body_params = ai_export_text_to_docx_request
        ...
        resource_path = "/api/2.0/ai/text-to-docx"
