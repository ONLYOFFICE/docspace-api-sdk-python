...
class EmailApi:
    ...
    def change_user_email(
        ...
        change_email_request: Annotated[ChangeEmailRequest, Field(description="The request parameters for updating a user email.")],
        ...
        :type userid: UUID
        :param change_email_request: The request parameters for updating a user email. (required)
        ...
        _param = self._change_user_email_serialize(
            userid=userid,
    ...
    @validate_call
    def change_user_email_with_http_info(
        self,
        userid: Annotated[UUID, Field(description="The user ID.")],
        change_email_request: Annotated[ChangeEmailRequest, Field(description="The request parameters for updating a user email.")],
        _request_timeout: Union[
    ...
    @validate_call
    def change_user_email_without_preload_content(
        self,
        userid: Annotated[UUID, Field(description="The user ID.")],
        change_email_request: Annotated[ChangeEmailRequest, Field(description="The request parameters for updating a user email.")],
        _request_timeout: Union[
    ...
    def _change_user_email_serialize(
        self,
        userid,
        ...
        resource_path = "/api/2.0/people/{userid}/email"
