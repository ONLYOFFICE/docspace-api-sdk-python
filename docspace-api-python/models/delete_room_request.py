...
class DeleteRoomRequest(BaseModel):
    ...
    """ # noqa: E501
    delete_after: Optional[StrictBool] = Field(default=None, description="Specifies whether to delete a room after the editing session is finished or not.", alias="deleteAfter")
