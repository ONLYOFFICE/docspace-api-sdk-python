...
class StartUpdateUserTypeDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reassign_user_id (nullable) is None
        # and model_fields_set contains the field
        if self.reassign_user_id is None and "reassign_user_id" in self.model_fields_set:
            _dict['reassignUserId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reassignUserId": obj.get("reassignUserId")
        })
        return _obj
