...
class MentionMessageWrapper(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of action_link
        if self.action_link:
            _dict['actionLink'] = self.action_link.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionLink": ActionLinkConfig.from_dict(obj["actionLink"]) if obj.get("actionLink") is not None else None,
