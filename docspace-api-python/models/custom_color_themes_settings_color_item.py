...
class CustomColorThemesSettingsColorItem(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if accent (nullable) is None
        # and model_fields_set contains the field
        if self.accent is None and "accent" in self.model_fields_set:
            _dict['accent'] = None

        # set to None if buttons (nullable) is None
        # and model_fields_set contains the field
        if self.buttons is None and "buttons" in self.model_fields_set:
            _dict['buttons'] = None
