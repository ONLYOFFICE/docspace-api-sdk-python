...
class PageableResponseClientInfoResponse(BaseModel):
    """
    The response containing paginated client information.
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = Field(default=None, description="The paginated client data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "limit": obj.get("limit"),
            "last_client_id": obj.get("last_client_id"),
            "last_created_on": obj.get("last_created_on")
        })
        return _obj
