...
class OpenCustomerSessionRequestDto(BaseModel):
    """
    Client session opening parameters
    """ # noqa: E501
    service_account: Optional[StrictInt] = Field(default=None, description="Service account", alias="serviceAccount")
    ...
    __properties: ClassVar[List[str]] = ["serviceAccount", "externalRef", "quantity"]
