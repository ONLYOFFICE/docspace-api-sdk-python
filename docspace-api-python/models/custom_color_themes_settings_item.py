...
class CustomColorThemesSettingsItem(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "main": CustomColorThemesSettingsColorItem.from_dict(obj["main"]) if obj.get("main") is not None else None,
            "text": CustomColorThemesSettingsColorItem.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
