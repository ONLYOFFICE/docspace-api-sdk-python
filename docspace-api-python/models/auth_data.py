...
class AuthData(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if raw_token (nullable) is None
        # and model_fields_set contains the field
        if self.raw_token is None and "raw_token" in self.model_fields_set:
            _dict['rawToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rawToken": obj.get("rawToken"),
            "url": obj.get("url"),
            "provider": obj.get("provider"),
            "token": OAuth20Token.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
