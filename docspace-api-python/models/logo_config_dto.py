...
class LogoConfigDto(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if image_dark (nullable) is None
        # and model_fields_set contains the field
        if self.image_dark is None and "image_dark" in self.model_fields_set:
            _dict['imageDark'] = None

        # set to None if image_light (nullable) is None
        # and model_fields_set contains the field
        if self.image_light is None and "image_light" in self.model_fields_set:
            _dict['imageLight'] = None

        # set to None if image_embedded (nullable) is None
        # and model_fields_set contains the field
        if self.image_embedded is None and "image_embedded" in self.model_fields_set:
            _dict['imageEmbedded'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": obj.get("image"),
            "imageDark": obj.get("imageDark"),
            "imageLight": obj.get("imageLight"),
            "imageEmbedded": obj.get("imageEmbedded"),
            "url": obj.get("url"),
