...
class PermissionsConfig(BaseModel):
    ...
    """ # noqa: E501
    change_history: Optional[StrictBool] = Field(default=None, description="Specifies whether to display the \"Restore\" button when using the \"onRequestRestore\" event.", alias="changeHistory")
    ...
    rename: Optional[StrictBool] = Field(default=None, description="Specifies whether to display the \"Rename...\" button when using the \"onRequestRename\" event.")
