...
class UpdateMembersQuotaRequestDto(BaseModel):
    """
    The request parameters for updating a user quota.
    """ # noqa: E501
    user_ids: Optional[List[StrictStr]] = Field(default=None, description="The list of user IDs.", alias="userIds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quota": UpdateMembersQuotaRequestDtoQuota.from_dict(obj["quota"]) if obj.get("quota") is not None else None
        })
        return _obj
