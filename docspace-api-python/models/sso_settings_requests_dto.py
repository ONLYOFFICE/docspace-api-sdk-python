...
class SsoSettingsRequestsDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if serialize_settings (nullable) is None
        # and model_fields_set contains the field
        if self.serialize_settings is None and "serialize_settings" in self.model_fields_set:
            _dict['serializeSettings'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serializeSettings": obj.get("serializeSettings")
        })
        return _obj
