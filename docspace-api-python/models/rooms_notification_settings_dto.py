...
class RoomsNotificationSettingsDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if disabled_rooms (nullable) is None
        # and model_fields_set contains the field
        if self.disabled_rooms is None and "disabled_rooms" in self.model_fields_set:
            _dict['disabledRooms'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disabledRooms": obj.get("disabledRooms")
        })
        return _obj
