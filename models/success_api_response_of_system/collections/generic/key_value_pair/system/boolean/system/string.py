...
if TYPE_CHECKING:
    from ........system.collections.generic.key_value_pair.system.boolean.system.string import String
    from .string_links import String_links

@dataclass
class String(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[String_links]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(String_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(String)),
