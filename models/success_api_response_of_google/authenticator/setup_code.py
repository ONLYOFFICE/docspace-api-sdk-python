...
if TYPE_CHECKING:
    from ...google.authenticator.setup_code import SetupCode
    from .setup_code_links import SetupCode_links

@dataclass
class SetupCode(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[SetupCode_links]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(SetupCode_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(SetupCode)),
