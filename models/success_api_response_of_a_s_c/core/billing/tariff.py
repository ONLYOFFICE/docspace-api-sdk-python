...
if TYPE_CHECKING:
    from ....a_s_c.core.billing.tariff import Tariff
    from .tariff_links import Tariff_links

@dataclass
class Tariff(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[Tariff_links]] = None
    # The response property
    response: Optional[Tariff] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(Tariff_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(Tariff)),
