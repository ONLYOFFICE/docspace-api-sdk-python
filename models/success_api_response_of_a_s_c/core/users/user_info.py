...
if TYPE_CHECKING:
    from ....a_s_c.core.users.user_info import UserInfo
    from .user_info_links import UserInfo_links
...
class UserInfo(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[UserInfo_links]] = None
    # The response property
    response: Optional[UserInfo] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(UserInfo_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(UserInfo)),
