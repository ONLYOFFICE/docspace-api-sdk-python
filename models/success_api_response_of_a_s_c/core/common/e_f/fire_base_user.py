...
if TYPE_CHECKING:
    from .....a_s_c.core.common.e_f.fire_base_user import FireBaseUser
    from .fire_base_user_links import FireBaseUser_links

@dataclass
class FireBaseUser(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[FireBaseUser_links]] = None
    # The response property
    response: Optional[FireBaseUser] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(FireBaseUser_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(FireBaseUser)),
