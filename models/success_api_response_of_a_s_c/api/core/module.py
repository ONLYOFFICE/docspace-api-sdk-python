...
if TYPE_CHECKING:
    from ....a_s_c.api.core.module import Module
...
class Module(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[Module_links]] = None
    # The response property
    response: Optional[Module] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(Module_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(Module)),
