...
if TYPE_CHECKING:
    from ......a_s_c.web.files.services.document_service.file_reference import FileReference
    from .file_reference_links import FileReference_links

@dataclass
class FileReference(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[FileReference_links]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(FileReference_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(FileReference)),
