...
if TYPE_CHECKING:
    from .....a_s_c.web.api.models.employee_full_dto import EmployeeFullDto
    from .employee_full_dto_links import EmployeeFullDto_links

@dataclass
class EmployeeFullDto(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[EmployeeFullDto_links]] = None
    # The response property
    response: Optional[EmployeeFullDto] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(EmployeeFullDto_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(EmployeeFullDto)),
