...
if TYPE_CHECKING:
    from ......a_s_c.web.api.api_model.requests_dto.ip_restrictions_dto import IpRestrictionsDto
    from .ip_restrictions_dto_links import IpRestrictionsDto_links

@dataclass
class IpRestrictionsDto(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[IpRestrictionsDto_links]] = None
    # New IP restriction settings
    response: Optional[IpRestrictionsDto] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(IpRestrictionsDto_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(IpRestrictionsDto)),
