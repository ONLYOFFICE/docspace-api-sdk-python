...
if TYPE_CHECKING:
    from ......a_s_c.web.api.api_models.response_dto.rooms_notification_settings_dto import RoomsNotificationSettingsDto
    from .rooms_notification_settings_dto_links import RoomsNotificationSettingsDto_links

@dataclass
class RoomsNotificationSettingsDto(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[RoomsNotificationSettingsDto_links]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(RoomsNotificationSettingsDto_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(RoomsNotificationSettingsDto)),
