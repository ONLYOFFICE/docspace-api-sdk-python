...
if TYPE_CHECKING:
    from .....a_s_c.people.api_models.response_dto.group_dto import GroupDto
    from .group_dto_links import GroupDto_links

@dataclass
class GroupDto(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[GroupDto_links]] = None
    # The response property
    response: Optional[GroupDto] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(GroupDto_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(GroupDto)),
