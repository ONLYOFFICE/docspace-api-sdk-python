...
if TYPE_CHECKING:
    from ....a_s_c.files.core.auto_clean_up_data import AutoCleanUpData
    from .auto_clean_up_data_links import AutoCleanUpData_links

@dataclass
class AutoCleanUpData(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[AutoCleanUpData_links]] = None
    # The response property
    response: Optional[AutoCleanUpData] = None
    # The status property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(AutoCleanUpData_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(AutoCleanUpData)),
