...
if TYPE_CHECKING:
    from ......a_s_c.files.core.api_models.response_dto.files_statistics_result_dto import FilesStatisticsResultDto
    from .files_statistics_result_dto_links import FilesStatisticsResultDto_links

@dataclass
class FilesStatisticsResultDto(AdditionalDataHolder, Parsable):
    ...
    # The links property
    links: Optional[List[FilesStatisticsResultDto_links]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(FilesStatisticsResultDto_links)),
            "response": lambda n : setattr(self, 'response', n.get_object_value(FilesStatisticsResultDto)),
