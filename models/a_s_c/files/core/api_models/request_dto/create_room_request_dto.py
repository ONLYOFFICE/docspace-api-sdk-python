...
if TYPE_CHECKING:
    from ..file_share_params import FileShareParams
...
@dataclass
class CreateRoomRequestDto(Parsable):
    """
    ...
    share: Optional[List[FileShareParams]] = None
    # List of tags
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreateRoomRequestDto:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: CreateRoomRequestDto
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "share": lambda n : setattr(self, 'share', n.get_collection_of_object_values(FileShareParams)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("share", self.share)
