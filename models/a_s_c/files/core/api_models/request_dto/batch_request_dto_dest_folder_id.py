...
@dataclass
class BatchRequestDto_destFolderId(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BatchRequestDto_destFolderId:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BatchRequestDto_destFolderId
        """
        ...
        try:
            ...
            mapping_value = None
        result = BatchRequestDto_destFolderId()
