...
@dataclass
class DownloadRequestItemDto_key(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DownloadRequestItemDto_key:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DownloadRequestItemDto_key
        """
        ...
        try:
            ...
            mapping_value = None
        result = DownloadRequestItemDto_key()
