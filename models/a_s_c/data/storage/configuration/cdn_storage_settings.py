...
if TYPE_CHECKING:
    ...
    from .cdn_storage_settings_props import CdnStorageSettings_props

@dataclass
class CdnStorageSettings(Parsable):
    # The module property
    module: Optional[str] = None
    # The props property
    props: Optional[CdnStorageSettings_props] = None
    # The switch property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "props": lambda n : setattr(self, 'props', n.get_object_value(CdnStorageSettings_props)),
