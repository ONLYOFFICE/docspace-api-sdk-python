...
class TypeInfo(Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TypeInfo:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "declaredConstructors": lambda n : setattr(self, 'declared_constructors', n.get_collection_of_object_values(ConstructorInfo)),
            "declaredEvents": lambda n : setattr(self, 'declared_events', n.get_collection_of_object_values(EventInfo)),
            "declaredFields": lambda n : setattr(self, 'declared_fields', n.get_collection_of_object_values(FieldInfo)),
            "declaredMembers": lambda n : setattr(self, 'declared_members', n.get_collection_of_object_values(MemberInfo)),
            "declaredMethods": lambda n : setattr(self, 'declared_methods', n.get_collection_of_object_values(MethodInfo)),
            "declaredNestedTypes": lambda n : setattr(self, 'declared_nested_types', n.get_collection_of_object_values(TypeInfo)),
            "declaredProperties": lambda n : setattr(self, 'declared_properties', n.get_collection_of_object_values(PropertyInfo)),
            ...
            "genericTypeParameters": lambda n : setattr(self, 'generic_type_parameters', n.get_collection_of_object_values(Type)),
            "guid": lambda n : setattr(self, 'guid', n.get_uuid_value()),
            "hasElementType": lambda n : setattr(self, 'has_element_type', n.get_bool_value()),
            "implementedInterfaces": lambda n : setattr(self, 'implemented_interfaces', n.get_collection_of_object_values(Type)),
