...
class EventInfo(Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EventInfo:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "addMethod": lambda n : setattr(self, 'add_method', n.get_object_value(MethodInfo)),
            ...
            "eventHandlerType": lambda n : setattr(self, 'event_handler_type', n.get_object_value(Type)),
            "isCollectible": lambda n : setattr(self, 'is_collectible', n.get_bool_value()),
            "isMulticast": lambda n : setattr(self, 'is_multicast', n.get_bool_value()),
            ...
            "raiseMethod": lambda n : setattr(self, 'raise_method', n.get_object_value(MethodInfo)),
            "reflectedType": lambda n : setattr(self, 'reflected_type', n.get_object_value(Type)),
            "removeMethod": lambda n : setattr(self, 'remove_method', n.get_object_value(MethodInfo)),
        }
        return fields
