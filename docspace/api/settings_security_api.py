...
class SettingsSecurityApi:
    ...
    def get_product_administrators(
        self,
        productid: Annotated[StrictStr, Field(description="Product ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_web_item_settings_security_info(
        self,
        ids: Annotated[Optional[List[List[StrictStr]]], Field(description="List of module IDs")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def is_product_administrator(
        self,
        productid: Annotated[Optional[StrictStr], Field(description="Product ID")] = None,
        ...
        _param = self._is_product_administrator_serialize(
            productid=productid,
            userid=userid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def is_product_administrator_with_http_info(
        self,
        productid: Annotated[Optional[StrictStr], Field(description="Product ID")] = None,
        userid: Annotated[Optional[StrictStr], Field(description="User ID")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def is_product_administrator_without_preload_content(
        self,
        productid: Annotated[Optional[StrictStr], Field(description="Product ID")] = None,
        userid: Annotated[Optional[StrictStr], Field(description="User ID")] = None,
        _request_timeout: Union[
    ...
    def _is_product_administrator_serialize(
        self,
        productid,
        userid,
        _request_auth,
