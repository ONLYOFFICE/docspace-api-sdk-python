...
class FilesSharingApi:
    ...
    def change_owner(
        ...
        _param = self._change_owner_serialize(
    ...
    @validate_call
    def change_owner_without_preload_content(
        self,
        change_owner_request_dto: Optional[ChangeOwnerRequestDto] = None,
        _request_timeout: Union[
            None,
    ...
    def shared_users(
        ...
        _param = self._shared_users_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def shared_users_with_http_info(
        self,
        file_id: Annotated[StrictInt, Field(description="The file ID of the request.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def shared_users_without_preload_content(
        self,
        file_id: Annotated[StrictInt, Field(description="The file ID of the request.")],
        _request_timeout: Union[
            None,
