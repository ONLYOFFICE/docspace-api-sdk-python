...
class PortalUsersApi:
    ...
    def ge_invite_link(
        self,
        employee_type: Annotated[EmployeeType, Field(description="Employee type (All, RoomAdmin, Guest, DocSpaceAdmin, User)")],
        ...
        :param employee_type: Employee type (All, RoomAdmin, Guest, DocSpaceAdmin, User) (required)
        ...
        _param = self._ge_invite_link_serialize(
    ...
    @validate_call
    def ge_invite_link_with_http_info(
        self,
        employee_type: Annotated[EmployeeType, Field(description="Employee type (All, RoomAdmin, Guest, DocSpaceAdmin, User)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ge_invite_link_without_preload_content(
        self,
        employee_type: Annotated[EmployeeType, Field(description="Employee type (All, RoomAdmin, Guest, DocSpaceAdmin, User)")],
        _request_timeout: Union[
            None,
    ...
    def mark_present_as_readed(
        ...
        _param = self._mark_present_as_readed_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def mark_present_as_readed_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def mark_present_as_readed_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _mark_present_as_readed_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def send_congratulations(
        self,
        userid: Annotated[Optional[StrictStr], Field(description="User ID")] = None,
        key: Annotated[Optional[StrictStr], Field(description="Email key")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
