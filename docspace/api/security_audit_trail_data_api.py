...
class SecurityAuditTrailDataApi:
    ...
    def get_audit_events_by_filter(
        ...
        product_type: Annotated[Optional[ProductType], Field(description="Product")] = None,
        module_type: Annotated[Optional[ModuleType], Field(description="Module")] = None,
        action_type: Annotated[Optional[ActionType], Field(description="Action type")] = None,
        action: Annotated[Optional[MessageAction], Field(description="Action")] = None,
        entry_type: Annotated[Optional[EntryType], Field(description="Entry")] = None,
        target: Annotated[Optional[StrictStr], Field(description="Target")] = None,
        var_from: Annotated[Optional[ApiDateTime], Field(description="Start date")] = None,
        to: Annotated[Optional[ApiDateTime], Field(description="End date")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_mappers(
        ...
        _param = self._get_mappers_serialize(
            product_type=product_type,
            module_type=module_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_mappers_with_http_info(
        self,
        product_type: Annotated[Optional[ProductType], Field(description="Product")] = None,
        module_type: Annotated[Optional[ModuleType], Field(description="Module")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_mappers_without_preload_content(
        self,
        product_type: Annotated[Optional[ProductType], Field(description="Product")] = None,
        module_type: Annotated[Optional[ModuleType], Field(description="Module")] = None,
        _request_timeout: Union[
