...
class PortalQuotaApi:
    ...
    def get_tariff(
        ...
        _param = self._get_tariff_serialize(
            refresh=refresh,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tariff_without_preload_content(
        self,
        refresh: Annotated[Optional[StrictBool], Field(description="The value indicating whether the current portal tariff information should be refreshed.")] = None,
        _request_timeout: Union[
            None,
    ...
    def get_used_space(
        ...
        _param = self._get_used_space_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_used_space_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_used_space_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
