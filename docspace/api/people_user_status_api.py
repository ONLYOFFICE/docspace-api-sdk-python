...
class PeopleUserStatusApi:
    ...
    def update_employee_activation_status(
        self,
        activationstatus: Annotated[EmployeeActivationStatus, Field(description="Activation status")],
        update_members_request_dto: Annotated[Optional[UpdateMembersRequestDto], Field(description="Update members")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param activationstatus: Activation status (required)
        :type activationstatus: EmployeeActivationStatus
        :param update_members_request_dto: Update members
    ...
    def update_user_status(
        self,
        status: Annotated[EmployeeStatus, Field(description="New user status")],
        update_members_request_dto: Annotated[Optional[UpdateMembersRequestDto], Field(description="Update members")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param status: New user status (required)
        :type status: EmployeeStatus
        :param update_members_request_dto: Update members
        :type update_members_request_dto: UpdateMembersRequestDto
        :param _request_timeout: timeout setting for this request. If one
