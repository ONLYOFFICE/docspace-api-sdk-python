...
class PeopleProfilesApi:
    ...
    def call_self(
        ...
        _param = self._call_self_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def call_self_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_by_email(
        self,
        email: Annotated[Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]], Field(description="User email address")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_by_email_serialize(
            email=email,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_by_email_with_http_info(
        self,
        email: Annotated[Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]], Field(description="User email address")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_by_email_without_preload_content(
        self,
        email: Annotated[Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]], Field(description="User email address")] = None,
        _request_timeout: Union[
            None,
    ...
    def update_member(
        self,
        userid: Annotated[StrictStr, Field(description="User ID")],
        update_member_request_dto: Annotated[Optional[UpdateMemberRequestDto], Field(description="Update member")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param userid: User ID (required)
        :type userid: str
        :param update_member_request_dto: Update member
        :type update_member_request_dto: UpdateMemberRequestDto
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
