...
class PeoplePhotosApi:
    ...
    def create_member_photo_thumbnails(
        ...
        thumbnails_request: Annotated[Optional[ThumbnailsRequest], Field(description="Thumbnails")] = None,
        ...
        :type userid: str
        :param thumbnails_request: Thumbnails
    ...
    def update_member_photo(
        self,
        userid: Annotated[StrictStr, Field(description="User ID")],
        update_photo_member_request: Annotated[Optional[UpdatePhotoMemberRequest], Field(description="Update photo")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param userid: User ID (required)
        :type userid: str
        :param update_photo_member_request: Update photo
