...
class SecurityDto(BaseModel):
    ...
    SecurityDto
    """ # noqa: E501
    web_item_id: Optional[StrictStr] = Field(default=None, description="Module ID", alias="webItemId")
    users: Optional[List[EmployeeDto]] = Field(default=None, description="List of users with the access to the module")
    groups: Optional[List[GroupSummaryDto]] = Field(default=None, description="List of groups with the access to the module")
    enabled: Optional[StrictBool] = Field(default=None, description="Specifies if the security settings are enabled or not")
    is_sub_item: Optional[StrictBool] = Field(default=None, description="Specifies if this module is a subitem or not", alias="isSubItem")
