...
class GetReferenceDataDtoInteger(BaseModel):
    ...
    """ # noqa: E501
    file_key: Optional[StrictInt] = Field(default=None, description="The unique document identifier used by the service to get a link to the file", alias="fileKey")
    instance_id: Optional[StrictStr] = Field(default=None, description="The unique system identifier", alias="instanceId")
    source_file_id: Optional[StrictInt] = Field(default=None, description="Source file ID", alias="sourceFileId")
    path: Optional[StrictStr] = Field(default=None, description="The file name or relative path for the formula editor")
    link: Optional[StrictStr] = Field(default=None, description="Link to file")
