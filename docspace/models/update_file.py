...
class UpdateFile(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="File title")
    last_version: Optional[StrictInt] = Field(default=None, description="Number of the latest file version", alias="lastVersion")
