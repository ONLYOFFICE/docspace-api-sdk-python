...
class AuthenticationTokenDto(BaseModel):
    ...
    expires: Optional[datetime] = Field(default=None, description="Token expiration time")
    sms: Optional[StrictBool] = Field(default=None, description="Specifies if the authentication code is sent by SMS or not")
    phone_noise: Optional[StrictStr] = Field(default=None, description="Phone number", alias="phoneNoise")
    tfa: Optional[StrictBool] = Field(default=None, description="Specifies if the two-factor application is used or not")
    tfa_key: Optional[StrictStr] = Field(default=None, description="Two-factor authentication key", alias="tfaKey")
    confirm_url: Optional[StrictStr] = Field(default=None, description="Confirmation email URL", alias="confirmUrl")
