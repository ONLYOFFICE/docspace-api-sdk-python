...
class InfoConfigDto(BaseModel):
    ...
    InfoConfigDto
    """ # noqa: E501
    favorite: Optional[StrictBool] = Field(default=None, description="Favorite")
    folder: Optional[StrictStr] = Field(default=None, description="Folder")
    owner: Optional[StrictStr] = Field(default=None, description="Owner")
    sharing_settings: Optional[List[AceShortWrapper]] = Field(default=None, description="Sharing settings", alias="sharingSettings")
    type: Optional[EditorType] = None
    uploaded: Optional[StrictStr] = Field(default=None, description="Uploaded")
