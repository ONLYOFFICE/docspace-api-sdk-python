...
class FireBaseUser(BaseModel):
    ...
    firebase_device_token: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Firebase device token", alias="firebaseDeviceToken")
    application: Optional[Annotated[str, Field(strict=True, max_length=20)]] = Field(default=None, description="Application")
