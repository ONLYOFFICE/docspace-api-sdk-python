...
class Operation(BaseModel):
    ...
    service_unit: Optional[StrictStr] = Field(default=None, alias="serviceUnit")
    quantity: Optional[StrictInt] = None
    currency: Optional[StrictStr] = None
    credit: Optional[Union[StrictFloat, StrictInt]] = None
    withdrawal: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["date", "service", "serviceUnit", "quantity", "currency", "credit", "withdrawal"]
