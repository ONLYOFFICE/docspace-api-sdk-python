...
class EmailValidationKeyModel(BaseModel):
    ...
    ui_d: Optional[StrictStr] = Field(default=None, description="User ID", alias="uiD")
    type: Optional[ConfirmType] = None
    first: Optional[StrictStr] = Field(default=None, description="Access an account for the first time or not")
