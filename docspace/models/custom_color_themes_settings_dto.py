...
class CustomColorThemesSettingsDto(BaseModel):
    ...
    """ # noqa: E501
    themes: Optional[List[CustomColorThemesSettingsItem]] = Field(default=None, description="Themes")
    selected: Optional[StrictInt] = Field(default=None, description="Selected")
