...
class CustomizationConfigDto(BaseModel):
    ...
    """ # noqa: E501
    about: Optional[StrictBool] = Field(default=None, description="About")
    ...
    mention_share: Optional[StrictBool] = Field(default=None, description="MentionShare", alias="mentionShare")
    review_display: Optional[StrictStr] = Field(default=None, description="Review display", alias="reviewDisplay")
    submit_form: Optional[StrictBool] = Field(default=None, description="Submit form", alias="submitForm")
    __properties: ClassVar[List[str]] = ["about", "customer", "anonymous", "feedback", "forcesave", "goback", "logo", "mentionShare", "reviewDisplay", "submitForm"]
