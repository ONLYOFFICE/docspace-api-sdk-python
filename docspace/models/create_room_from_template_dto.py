...
class CreateRoomFromTemplateDto(BaseModel):
    ...
    """ # noqa: E501
    template_id: Optional[StrictInt] = Field(default=None, description="Template id", alias="templateId")
    title: Optional[StrictStr] = Field(default=None, description="Title")
    logo: Optional[LogoRequest] = None
    copy_logo: Optional[StrictBool] = Field(default=None, description="Copy logo", alias="copyLogo")
    ...
    __properties: ClassVar[List[str]] = ["templateId", "title", "logo", "copyLogo", "tags", "color", "cover"]
