...
class SmtpSettingsDto(BaseModel):
    ...
    port: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, description="Port")
    sender_address: Optional[StrictStr] = Field(default=None, description="Sender address", alias="senderAddress")
    sender_display_name: Optional[StrictStr] = Field(default=None, description="Sender display name", alias="senderDisplayName")
    credentials_user_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Credentials username", alias="credentialsUserName")
    credentials_user_password: Optional[StrictStr] = Field(default=None, description="Credentials user password", alias="credentialsUserPassword")
    enable_ssl: Optional[StrictBool] = Field(default=None, description="Enables SSL or not", alias="enableSSL")
    enable_auth: Optional[StrictBool] = Field(default=None, description="Enables authentication or not", alias="enableAuth")
