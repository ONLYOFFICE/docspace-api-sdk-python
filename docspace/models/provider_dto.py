...
class ProviderDto(BaseModel):
    ...
    key: Optional[StrictStr] = Field(default=None, description="Provider key")
    connected: Optional[StrictBool] = Field(default=None, description="Connected flag")
    oauth: Optional[StrictBool] = Field(default=None, description="Oauth flag")
    redirect_url: Optional[StrictStr] = Field(default=None, description="Redirect url", alias="redirectUrl")
    required_connection_url: Optional[StrictBool] = Field(default=None, description="Required connection url flag", alias="requiredConnectionUrl")
