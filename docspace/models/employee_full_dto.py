...
class EmployeeFullDto(BaseModel):
    ...
    avatar: Optional[StrictStr] = Field(default=None, description="Avatar")
    avatar_original: Optional[StrictStr] = Field(default=None, description="Original size avatar", alias="avatarOriginal")
    avatar_max: Optional[StrictStr] = Field(default=None, description="Maximum size avatar", alias="avatarMax")
    avatar_medium: Optional[StrictStr] = Field(default=None, description="Medium size avatar", alias="avatarMedium")
    avatar_small: Optional[StrictStr] = Field(default=None, description="Small avatar", alias="avatarSmall")
    profile_url: Optional[StrictStr] = Field(default=None, description="Profile URL", alias="profileUrl")
    has_avatar: Optional[StrictBool] = Field(default=None, description="Specifies if the user has an avatar or not", alias="hasAvatar")
    is_anonim: Optional[StrictBool] = Field(default=None, description="Specifies if the user is an anonim or not", alias="isAnonim")
    ...
    contacts: Optional[List[Contact]] = Field(default=None, description="List of contacts")
    birthday: Optional[ApiDateTime] = None
    sex: Optional[StrictStr] = Field(default=None, description="Sex")
    ...
    groups: Optional[List[GroupSummaryDto]] = Field(default=None, description="List of groups")
    ...
    list_admin_modules: Optional[List[StrictStr]] = Field(default=None, description="List of administrator modules", alias="listAdminModules")
    ...
    culture_name: Optional[StrictStr] = Field(default=None, description="Language", alias="cultureName")
    ...
    quota_limit: Optional[StrictInt] = Field(default=None, description="Quota limit", alias="quotaLimit")
    used_space: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Portal used space", alias="usedSpace")
    shared: Optional[StrictBool] = Field(default=None, description="Shared")
    ...
    login_event_id: Optional[StrictInt] = Field(default=None, description="Current login event ID", alias="loginEventId")
