...
class RoomTemplateStatusDto(BaseModel):
    ...
    progress: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Progress")
    error: Optional[StrictStr] = Field(default=None, description="Error")
    is_completed: Optional[StrictBool] = Field(default=None, description="IsCompleted", alias="isCompleted")
