...
class DbTenant(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Name")
    alias: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Alias")
    ...
    version_changed: Optional[datetime] = Field(default=None, description="Version_changed", alias="version_Changed")
    version_changed: Optional[datetime] = Field(default=None, description="Version changed", alias="versionChanged")
    language: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="Language")
    time_zone: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Time zone", alias="timeZone")
    trusted_domains_raw: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Trusted domains raw", alias="trustedDomainsRaw")
    trusted_domains_enabled: Optional[TenantTrustedDomainsType] = Field(default=None, alias="trustedDomainsEnabled")
    status: Optional[TenantStatus] = None
    status_changed: Optional[datetime] = Field(default=None, description="Status changed", alias="statusChanged")
    status_changed_hack: Optional[datetime] = Field(default=None, description="Status changed hack", alias="statusChangedHack")
    creation_date_time: Optional[datetime] = Field(default=None, description="Creation date time", alias="creationDateTime")
    owner_id: Optional[StrictStr] = Field(default=None, description="Owner id", alias="ownerId")
    payment_id: Optional[Annotated[str, Field(strict=True, max_length=38)]] = Field(default=None, description="Payment id", alias="paymentId")
    industry: Optional[TenantIndustry] = None
    last_modified: Optional[datetime] = Field(default=None, description="Last modified", alias="lastModified")
    calls: Optional[StrictBool] = Field(default=None, description="Calls")
