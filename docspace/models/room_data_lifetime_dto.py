...
class RoomDataLifetimeDto(BaseModel):
    ...
    """ # noqa: E501
    delete_permanently: Optional[StrictBool] = Field(default=None, description="Specifies action", alias="deletePermanently")
    period: Optional[RoomDataLifetimePeriod] = None
    value: Optional[Annotated[int, Field(le=999, strict=True, ge=1)]] = Field(default=None, description="Specifies time period value")
