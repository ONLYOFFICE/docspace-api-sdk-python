...
class EditHistoryDto(BaseModel):
    ...
    changes_history: Optional[StrictStr] = Field(default=None, description="History changes in the string format", alias="changesHistory")
    changes: Optional[List[EditHistoryChangesWrapper]] = Field(default=None, description="List of history changes")
    server_version: Optional[StrictStr] = Field(default=None, description="Server version", alias="serverVersion")
