...
class WebItemSecurityRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Module ID")
    enabled: Optional[StrictBool] = Field(default=None, description="Specifies if the module security settings are enabled or not")
    subjects: Optional[List[StrictStr]] = Field(default=None, description="List of user/group IDs with the access to the module")
