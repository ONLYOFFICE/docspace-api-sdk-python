...
class SettingsDto(BaseModel):
    ...
    SettingsDto
    """ # noqa: E501
    timezone: Optional[StrictStr] = Field(default=None, description="Time zone")
    trusted_domains: Optional[List[StrictStr]] = Field(default=None, description="List of trusted domains", alias="trustedDomains")
    trusted_domains_type: Optional[TenantTrustedDomainsType] = Field(default=None, alias="trustedDomainsType")
    culture: Optional[StrictStr] = Field(default=None, description="Language")
    utc_offset: Optional[StrictStr] = Field(default=None, description="UTC offset", alias="utcOffset")
    utc_hours_offset: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="UTC hours offset", alias="utcHoursOffset")
    greeting_settings: Optional[StrictStr] = Field(default=None, description="Greeting settings", alias="greetingSettings")
    owner_id: Optional[StrictStr] = Field(default=None, description="Owner ID", alias="ownerId")
    name_schema_id: Optional[StrictStr] = Field(default=None, description="Team template ID", alias="nameSchemaId")
    enabled_join: Optional[StrictBool] = Field(default=None, description="Specifies if a user can join to the portal or not", alias="enabledJoin")
    enable_adm_mess: Optional[StrictBool] = Field(default=None, description="Specifies if a user can send a message to the administrator or not", alias="enableAdmMess")
    thirdparty_enable: Optional[StrictBool] = Field(default=None, description="Specifies if a user can connect third-party providers or not", alias="thirdpartyEnable")
    doc_space: Optional[StrictBool] = Field(default=None, description="Specifies if this is a DocSpace portal or not", alias="docSpace")
    standalone: Optional[StrictBool] = Field(default=None, description="Specifies if this is a standalone portal or not")
    is_ami: Optional[StrictBool] = Field(default=None, description="Specifies if this is a AMI instance or not", alias="isAmi")
    base_domain: Optional[StrictStr] = Field(default=None, description="Base domain", alias="baseDomain")
    wizard_token: Optional[StrictStr] = Field(default=None, description="Wizard token", alias="wizardToken")
    ...
    recaptcha_public_key: Optional[StrictStr] = Field(default=None, description="ReCAPTCHA public key", alias="recaptchaPublicKey")
    ...
    socket_url: Optional[StrictStr] = Field(default=None, description="Socket URL", alias="socketUrl")
    tenant_status: Optional[TenantStatus] = Field(default=None, alias="tenantStatus")
    tenant_alias: Optional[StrictStr] = Field(default=None, description="Tenant alias", alias="tenantAlias")
    display_about: Optional[StrictBool] = Field(default=None, description="Specifies whether to display the About section", alias="displayAbout")
    domain_validator: Optional[TenantDomainValidator] = Field(default=None, alias="domainValidator")
    zendesk_key: Optional[StrictStr] = Field(default=None, description="Zendesk key", alias="zendeskKey")
    tag_manager_id: Optional[StrictStr] = Field(default=None, description="Tag manager ID", alias="tagManagerId")
    ...
    limited_access_space: Optional[StrictBool] = Field(default=None, description="Limited access space", alias="limitedAccessSpace")
    user_name_regex: Optional[StrictStr] = Field(default=None, description="User name validation regex", alias="userNameRegex")
    invitation_limit: Optional[StrictInt] = Field(default=None, description="Invitation limit", alias="invitationLimit")
