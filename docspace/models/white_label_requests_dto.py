...
class WhiteLabelRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    logo_text: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=40)]] = Field(default=None, description="Logo text", alias="logoText")
    logo: Optional[List[ItemKeyValuePairStringLogoRequestsDto]] = Field(default=None, description="Tenant IDs with their logos (light or dark)")
