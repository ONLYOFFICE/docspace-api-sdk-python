...
class SsoIdpSettings(BaseModel):
    ...
    SsoIdpSettings
    """ # noqa: E501
    entity_id: Optional[StrictStr] = Field(default=None, description="Entity ID", alias="entityId")
    sso_url: Optional[StrictStr] = Field(default=None, description="SSO URL", alias="ssoUrl")
    sso_binding: Optional[StrictStr] = Field(default=None, description="SSO binding", alias="ssoBinding")
    slo_url: Optional[StrictStr] = Field(default=None, description="SLO URL", alias="sloUrl")
    slo_binding: Optional[StrictStr] = Field(default=None, description="SLO binding", alias="sloBinding")
    name_id_format: Optional[StrictStr] = Field(default=None, description="Name ID format", alias="nameIdFormat")
