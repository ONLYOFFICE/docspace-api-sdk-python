...
class FilesStatisticsFolder(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Folder title")
    used_space: Optional[StrictInt] = Field(default=None, description="Used space", alias="usedSpace")
