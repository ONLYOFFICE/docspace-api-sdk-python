...
class LoginSettingsDto(BaseModel):
    ...
    LoginSettingsDto
    """ # noqa: E501
    attempt_count: Optional[StrictInt] = Field(default=None, description="Maximum number of the user attempts to log in", alias="attemptCount")
    block_time: Optional[StrictInt] = Field(default=None, description="The time for which the user will be blocked after unsuccessful login attempts", alias="blockTime")
    check_period: Optional[StrictInt] = Field(default=None, description="The time to wait for a response from the server", alias="checkPeriod")
