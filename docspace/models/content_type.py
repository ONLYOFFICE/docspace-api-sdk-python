...
class ContentType(BaseModel):
    ...
    char_set: Optional[StrictStr] = Field(default=None, alias="charSet")
    media_type: Optional[StrictStr] = Field(default=None, alias="mediaType")
    name: Optional[StrictStr] = None
    parameters: Optional[List[Any]] = None
    __properties: ClassVar[List[str]] = ["boundary", "charSet", "mediaType", "name", "parameters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if char_set (nullable) is None
        # and model_fields_set contains the field
        if self.char_set is None and "char_set" in self.model_fields_set:
            _dict['charSet'] = None
