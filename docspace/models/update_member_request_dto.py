...
class UpdateMemberRequestDto(BaseModel):
    ...
    email: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Email")
    is_user: Optional[StrictBool] = Field(default=None, description="Specifies if this is a guest or a user", alias="isUser")
    first_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="First name", alias="firstName")
    last_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Last name", alias="lastName")
    department: Optional[List[StrictStr]] = Field(default=None, description="List of user departments")
    title: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Title")
    ...
    contacts: Optional[List[Contact]] = Field(default=None, description="List of user contacts")
    files: Optional[StrictStr] = Field(default=None, description="Avatar photo URL")
    culture_name: Optional[StrictStr] = Field(default=None, description="Language", alias="cultureName")
    spam: Optional[StrictBool] = Field(default=None, description="Spam")
    __properties: ClassVar[List[str]] = ["userId", "disable", "email", "isUser", "firstName", "lastName", "department", "title", "location", "sex", "birthday", "worksfrom", "comment", "contacts", "files", "cultureName", "spam"]
