...
class GroupDto(BaseModel):
    ...
    parent: Optional[StrictStr] = Field(default=None, description="Parent")
    ...
    members: Optional[List[EmployeeFullDto]] = Field(default=None, description="List of members")
    shared: Optional[StrictBool] = Field(default=None, description="Shared")
    members_count: Optional[StrictInt] = Field(default=None, description="Members count", alias="membersCount")
