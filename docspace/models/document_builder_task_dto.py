...
class DocumentBuilderTaskDto(BaseModel):
    ...
    percentage: Optional[StrictInt] = Field(default=None, description="Percentage")
    is_completed: Optional[StrictBool] = Field(default=None, description="Is completed", alias="isCompleted")
    status: Optional[DistributedTaskStatus] = None
    result_file_id: Optional[Any] = Field(default=None, description="Result file id", alias="resultFileId")
    result_file_name: Optional[StrictStr] = Field(default=None, description="Result file name", alias="resultFileName")
    result_file_url: Optional[StrictStr] = Field(default=None, description="Result file url", alias="resultFileUrl")
