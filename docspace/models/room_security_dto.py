...
class RoomSecurityDto(BaseModel):
    ...
    RoomSecurityDto
    """ # noqa: E501
    members: Optional[List[FileShareDto]] = Field(default=None, description="List of room members")
    warning: Optional[StrictStr] = Field(default=None, description="Warning")
    __properties: ClassVar[List[str]] = ["members", "warning"]
