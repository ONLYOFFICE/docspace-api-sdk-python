...
class StorageDto(BaseModel):
    ...
    properties: Optional[List[AuthKey]] = Field(default=None, description="List of authentication keys")
    current: Optional[StrictBool] = Field(default=None, description="Specifies if this is the current storage or not")
