...
class DocumentConfigDto(BaseModel):
    ...
    is_linked_for_me: Optional[StrictBool] = Field(default=None, description="Is linked for me", alias="isLinkedForMe")
    key: Optional[StrictStr] = Field(default=None, description="Key")
    permissions: Optional[PermissionsConfig] = None
    shared_link_param: Optional[StrictStr] = Field(default=None, description="Shared link param", alias="sharedLinkParam")
    shared_link_key: Optional[StrictStr] = Field(default=None, description="Shared link key", alias="sharedLinkKey")
    ...
    __properties: ClassVar[List[str]] = ["fileType", "info", "isLinkedForMe", "key", "permissions", "sharedLinkParam", "sharedLinkKey", "referenceData", "title", "url", "options"]
