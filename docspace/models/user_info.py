...
class UserInfo(BaseModel):
    ...
    birth_date: Optional[datetime] = Field(default=None, description="Birthday", alias="birthDate")
    sex: Optional[StrictBool] = Field(default=None, description="Sex (male or female)")
    ...
    work_from_date: Optional[datetime] = Field(default=None, description="Registration date", alias="workFromDate")
    email: Optional[StrictStr] = Field(default=None, description="Email")
    contacts: Optional[StrictStr] = Field(default=None, description="List of contacts in the string format")
    contacts_list: Optional[List[StrictStr]] = Field(default=None, description="List of contacts", alias="contactsList")
    ...
    last_modified: Optional[datetime] = Field(default=None, description="Last modified date", alias="lastModified")
    tenant_id: Optional[StrictInt] = Field(default=None, description="Tenant ID", alias="tenantId")
    is_active: Optional[StrictBool] = Field(default=None, description="Spceifies if the user is active or not", alias="isActive")
    culture_name: Optional[StrictStr] = Field(default=None, description="Language", alias="cultureName")
    mobile_phone: Optional[StrictStr] = Field(default=None, description="Mobile phone", alias="mobilePhone")
    mobile_phone_activation_status: Optional[MobilePhoneActivationStatus] = Field(default=None, alias="mobilePhoneActivationStatus")
    sid: Optional[StrictStr] = Field(default=None, description="LDAP user identificator")
    ldap_qouta: Optional[StrictInt] = Field(default=None, description="LDAP user quota attribute", alias="ldapQouta")
    sso_name_id: Optional[StrictStr] = Field(default=None, description="SSO SAML user identificator", alias="ssoNameId")
    sso_session_id: Optional[StrictStr] = Field(default=None, description="SSO SAML user session identificator", alias="ssoSessionId")
    create_date: Optional[datetime] = Field(default=None, description="Creation date", alias="createDate")
