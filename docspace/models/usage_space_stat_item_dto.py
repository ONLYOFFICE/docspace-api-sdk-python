...
class UsageSpaceStatItemDto(BaseModel):
    ...
    disabled: Optional[StrictBool] = Field(default=None, description="Specifies if the module space is disabled or not")
    size: Optional[StrictStr] = Field(default=None, description="Size")
