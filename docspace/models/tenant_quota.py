...
class TenantQuota(BaseModel):
    ...
    TenantQuota
    """ # noqa: E501
    tenant_id: Optional[StrictInt] = Field(default=None, description="Tenant ID", alias="tenantId")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Price")
    price_currency_symbol: Optional[StrictStr] = Field(default=None, description="Price currency symbol", alias="priceCurrencySymbol")
    ...
    features: Optional[StrictStr] = Field(default=None, description="Tenant quota features")
    max_file_size: Optional[StrictInt] = Field(default=None, description="Maximum file size", alias="maxFileSize")
    max_total_size: Optional[StrictInt] = Field(default=None, description="Maximum total size", alias="maxTotalSize")
    count_user: Optional[StrictInt] = Field(default=None, description="Number of portal users", alias="countUser")
    count_room_admin: Optional[StrictInt] = Field(default=None, description="Number of portal room administrators", alias="countRoomAdmin")
    users_in_room: Optional[StrictInt] = Field(default=None, description="Number of room users", alias="usersInRoom")
    count_room: Optional[StrictInt] = Field(default=None, description="Number of rooms", alias="countRoom")
    ...
    docs_edition: Optional[StrictBool] = Field(default=None, description="Specifies if this tenant quota is Docs edition or not", alias="docsEdition")
    ...
    statistic: Optional[StrictBool] = Field(default=None, description="Specifies if the statistic settings are available or not")
    ...
    lifetime: Optional[StrictBool] = Field(default=None, description="Specifies if the license is lifetime or not")
    custom: Optional[StrictBool] = Field(default=None, description="Specifies if the custom domain URL is available or not")
    auto_backup_restore: Optional[StrictBool] = Field(default=None, description="Specifies if the automatic Backup&Restore feature is available or not", alias="autoBackupRestore")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "name", "price", "priceCurrencySymbol", "productId", "visible", "features", "maxFileSize", "maxTotalSize", "countUser", "countRoomAdmin", "usersInRoom", "countRoom", "nonProfit", "trial", "free", "update", "audit", "docsEdition", "ldap", "sso", "statistic", "branding", "customization", "lifetime", "custom", "autoBackupRestore", "oauth", "contentSearch", "thirdParty", "year"]
