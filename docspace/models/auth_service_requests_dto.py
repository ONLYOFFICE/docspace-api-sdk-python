...
class AuthServiceRequestsDto(BaseModel):
    ...
    instruction: Optional[StrictStr] = Field(default=None, description="Instruction")
    can_set: Optional[StrictBool] = Field(default=None, description="Specifies if the authentication service can be set or not", alias="canSet")
    props: Optional[List[AuthKey]] = Field(default=None, description="List of authorization keys")
