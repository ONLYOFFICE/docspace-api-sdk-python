...
class RoomLinkRequest(BaseModel):
    ...
    Link parameters
    """ # noqa: E501
    link_id: Optional[StrictStr] = Field(default=None, description="Link ID", alias="linkId")
    access: Optional[FileShare] = None
    expiration_date: Optional[ApiDateTime] = Field(default=None, alias="expirationDate")
    title: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Link name")
    link_type: Optional[LinkType] = Field(default=None, alias="linkType")
    password: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Link password")
    deny_download: Optional[StrictBool] = Field(default=None, description="Specifies whether downloading a file from a link is disabled or not", alias="denyDownload")
