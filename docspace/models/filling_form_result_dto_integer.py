...
class FillingFormResultDtoInteger(BaseModel):
    ...
    """ # noqa: E501
    form_number: Optional[StrictInt] = Field(default=None, description="Form number", alias="formNumber")
    ...
    is_room_member: Optional[StrictBool] = Field(default=None, description="Is room member", alias="isRoomMember")
