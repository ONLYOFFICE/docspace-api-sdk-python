...
class CreateFileJsonElement(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=165)]] = Field(default=None, description="File title")
    ...
    form_id: Optional[StrictInt] = Field(default=None, description="Form ID", alias="formId")
