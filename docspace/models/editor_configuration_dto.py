...
class EditorConfigurationDto(BaseModel):
    ...
    create_url: Optional[StrictStr] = Field(default=None, description="Create url", alias="createUrl")
    ...
    mode: Optional[StrictStr] = Field(default=None, description="Mode")
    mode_write: Optional[StrictBool] = Field(default=None, description="Mode write", alias="modeWrite")
    plugins: Optional[PluginsConfig] = None
    recent: Optional[List[RecentConfig]] = Field(default=None, description="Recent")
    templates: Optional[List[TemplatesConfig]] = Field(default=None, description="Templates")
