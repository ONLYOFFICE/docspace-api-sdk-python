...
class StartReassignRequestDto(BaseModel):
    ...
    """ # noqa: E501
    from_user_id: Optional[StrictStr] = Field(default=None, description="User ID whose data will be reassigned to another user", alias="fromUserId")
    to_user_id: Optional[StrictStr] = Field(default=None, description="User ID to whom all the data will be reassigned", alias="toUserId")
