...
class SsoSettingsV2(BaseModel):
    ...
    SsoSettingsV2
    """ # noqa: E501
    enable_sso: Optional[StrictBool] = Field(default=None, description="Specifies if SSO is enabled or not", alias="enableSso")
    idp_settings: Optional[SsoIdpSettings] = Field(default=None, alias="idpSettings")
    idp_certificates: Optional[List[SsoCertificate]] = Field(default=None, description="List of IDP certificates", alias="idpCertificates")
    idp_certificate_advanced: Optional[SsoIdpCertificateAdvanced] = Field(default=None, alias="idpCertificateAdvanced")
    sp_login_label: Optional[StrictStr] = Field(default=None, description="SP login label", alias="spLoginLabel")
    sp_certificates: Optional[List[SsoCertificate]] = Field(default=None, description="List of SP certificates", alias="spCertificates")
    ...
    users_type: Optional[StrictInt] = Field(default=None, description="Users type", alias="usersType")
    ...
    __properties: ClassVar[List[str]] = ["enableSso", "idpSettings", "idpCertificates", "idpCertificateAdvanced", "spLoginLabel", "spCertificates", "spCertificateAdvanced", "fieldMapping", "hideAuthPage", "usersType", "disableEmailVerification"]
