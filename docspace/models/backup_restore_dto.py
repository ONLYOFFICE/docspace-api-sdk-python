...
class BackupRestoreDto(BaseModel):
    ...
    """ # noqa: E501
    backup_id: Optional[StrictStr] = Field(default=None, description="Backup ID", alias="backupId")
    ...
    notify: Optional[StrictBool] = Field(default=None, description="Notifies users about portal restoring process or not")
    dump: Optional[StrictBool] = Field(default=None, description="Expect  dump or not")
