...
class FirebaseRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    firebase_device_token: Optional[StrictStr] = Field(default=None, description="Firebase device token", alias="firebaseDeviceToken")
    is_subscribed: Optional[StrictBool] = Field(default=None, description="Specifies if the user is subscribed to the push notification or not", alias="isSubscribed")
