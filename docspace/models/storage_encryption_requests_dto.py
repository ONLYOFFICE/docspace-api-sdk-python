...
class StorageEncryptionRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    notify_users: Optional[StrictBool] = Field(default=None, description="Specifies if the users will be notified about the encryption process or note", alias="notifyUsers")
