...
class DbTenantPartner(BaseModel):
    ...
    partner_id: Optional[Annotated[str, Field(strict=True, max_length=36)]] = Field(default=None, description="Partner id", alias="partnerId")
    affiliate_id: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Affiliate id", alias="affiliateId")
    campaign: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Campaign")
