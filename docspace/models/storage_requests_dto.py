...
class StorageRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    module: Optional[StrictStr] = Field(default=None, description="Storage name")
    props: Optional[List[ItemKeyValuePairStringString]] = Field(default=None, description="Storage properties")
