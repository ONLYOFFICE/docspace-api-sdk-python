...
class MailDomainSettingsRequestsDto(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[TenantTrustedDomainsType] = None
    domains: Optional[List[StrictStr]] = Field(default=None, description="List of trusted domains")
    invite_users_as_visitors: Optional[StrictBool] = Field(default=None, description="Invites as a user or not", alias="inviteUsersAsVisitors")
