...
class ApiDateTime(BaseModel):
    ...
    ApiDateTime
    """ # noqa: E501
    utc_time: Optional[datetime] = Field(default=None, description="UtcTime", alias="utcTime")
    time_zone_offset: Optional[StrictStr] = Field(default=None, description="TimeZoneOffset", alias="timeZoneOffset")
