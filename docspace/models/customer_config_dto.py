...
class CustomerConfigDto(BaseModel):
    ...
    logo_dark: Optional[StrictStr] = Field(default=None, description="Dark logo", alias="logoDark")
    mail: Optional[StrictStr] = Field(default=None, description="Mail")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    www: Optional[StrictStr] = Field(default=None, description="Site")
