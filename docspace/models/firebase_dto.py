...
class FirebaseDto(BaseModel):
    ...
    auth_domain: Optional[StrictStr] = Field(default=None, description="Authentication domain", alias="authDomain")
    project_id: Optional[StrictStr] = Field(default=None, description="Project ID", alias="projectId")
    storage_bucket: Optional[StrictStr] = Field(default=None, description="Storage bucket", alias="storageBucket")
    messaging_sender_id: Optional[StrictStr] = Field(default=None, description="Message sender ID", alias="messagingSenderId")
    app_id: Optional[StrictStr] = Field(default=None, description="Application ID", alias="appId")
    measurement_id: Optional[StrictStr] = Field(default=None, description="Measurement ID", alias="measurementId")
    database_url: Optional[StrictStr] = Field(default=None, description="Database URL", alias="databaseURL")
