...
class CheckDocServiceUrlRequestDto(BaseModel):
    ...
    """ # noqa: E501
    doc_service_url: Optional[StrictStr] = Field(default=None, description="The Document Server address", alias="docServiceUrl")
    doc_service_url_internal: Optional[StrictStr] = Field(default=None, description="The Document Server address in the local private network", alias="docServiceUrlInternal")
    doc_service_url_portal: Optional[StrictStr] = Field(default=None, description="The Community Server address", alias="docServiceUrlPortal")
    doc_service_signature_secret: Optional[StrictStr] = Field(default=None, description="Signature secret", alias="docServiceSignatureSecret")
    doc_service_signature_header: Optional[StrictStr] = Field(default=None, description="Signature header", alias="docServiceSignatureHeader")
