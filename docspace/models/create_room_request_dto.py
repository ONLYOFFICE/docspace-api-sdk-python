...
class CreateRoomRequestDto(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=170)]] = Field(default=None, description="Room name")
    ...
    deny_download: Optional[StrictBool] = Field(default=None, description="Room quota", alias="denyDownload")
    ...
    share: Optional[List[FileShareParams]] = Field(default=None, description="Collection of sharing parameters")
