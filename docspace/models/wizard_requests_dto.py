...
class WizardRequestsDto(BaseModel):
    ...
    lng: Optional[StrictStr] = Field(default=None, description="Language")
    time_zone: Optional[StrictStr] = Field(default=None, description="Time zone", alias="timeZone")
    ami_id: Optional[StrictStr] = Field(default=None, description="AMI ID", alias="amiId")
    subscribe_from_site: Optional[StrictBool] = Field(default=None, description="Subscribed from the site or not", alias="subscribeFromSite")
