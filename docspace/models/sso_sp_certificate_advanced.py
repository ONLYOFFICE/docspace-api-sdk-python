...
class SsoSpCertificateAdvanced(BaseModel):
    ...
    """ # noqa: E501
    signing_algorithm: Optional[StrictStr] = Field(default=None, description="Signing algorithm", alias="signingAlgorithm")
    ...
    sign_logout_responses: Optional[StrictBool] = Field(default=None, description="Specifies if sign the SAML logout responses sent to IdP or not", alias="signLogoutResponses")
    encrypt_algorithm: Optional[StrictStr] = Field(default=None, description="Encryption algorithm", alias="encryptAlgorithm")
    decrypt_algorithm: Optional[StrictStr] = Field(default=None, description="Decryption algorithm", alias="decryptAlgorithm")
