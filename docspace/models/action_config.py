...
class ActionConfig(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[StrictStr] = Field(default=None, description="The action data that will be scrolled to.")
    type: Optional[StrictStr] = Field(default=None, description="The action type.")
