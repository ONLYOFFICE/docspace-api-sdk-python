...
class ConversationResultDto(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="Source file")
    result: Optional[Any] = Field(default=None, description="Resulting file")
    error: Optional[StrictStr] = Field(default=None, description="Error")
    processed: Optional[StrictStr] = Field(default=None, description="Specifies if the operation is processed or not")
