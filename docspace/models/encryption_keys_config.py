...
class EncryptionKeysConfig(BaseModel):
    ...
    """ # noqa: E501
    crypto_engine_id: Optional[StrictStr] = Field(default=None, description="Crypto engine id", alias="cryptoEngineId")
    private_key_enc: Optional[StrictStr] = Field(default=None, description="Private key enc", alias="privateKeyEnc")
