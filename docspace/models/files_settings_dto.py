...
class FilesSettingsDto(BaseModel):
    ...
    FilesSettingsDto
    """ # noqa: E501
    exts_image_previewed: Optional[List[StrictStr]] = Field(default=None, description="Exts image previewed", alias="extsImagePreviewed")
    exts_media_previewed: Optional[List[StrictStr]] = Field(default=None, description="Exts media previewed", alias="extsMediaPreviewed")
    exts_web_previewed: Optional[List[StrictStr]] = Field(default=None, description="Exts web previewed", alias="extsWebPreviewed")
    exts_web_edited: Optional[List[StrictStr]] = Field(default=None, description="Exts web edited", alias="extsWebEdited")
    exts_web_encrypt: Optional[List[StrictStr]] = Field(default=None, description="Exts web encrypt", alias="extsWebEncrypt")
    exts_web_reviewed: Optional[List[StrictStr]] = Field(default=None, description="Exts web reviewed", alias="extsWebReviewed")
    exts_web_custom_filter_editing: Optional[List[StrictStr]] = Field(default=None, description="Exts web custom filter editing", alias="extsWebCustomFilterEditing")
    exts_web_restricted_editing: Optional[List[StrictStr]] = Field(default=None, description="Exts web restricted editing", alias="extsWebRestrictedEditing")
    exts_web_commented: Optional[List[StrictStr]] = Field(default=None, description="Exts web commented", alias="extsWebCommented")
    exts_web_template: Optional[List[StrictStr]] = Field(default=None, description="Exts web template", alias="extsWebTemplate")
    exts_co_authoring: Optional[List[StrictStr]] = Field(default=None, description="Exts co authoring", alias="extsCoAuthoring")
    exts_must_convert: Optional[List[StrictStr]] = Field(default=None, description="Exts must convert", alias="extsMustConvert")
    exts_convertible: Optional[Dict[str, Optional[List[StrictStr]]]] = Field(default=None, description="Exts convertible", alias="extsConvertible")
    exts_uploadable: Optional[List[StrictStr]] = Field(default=None, description="Exts uploadable", alias="extsUploadable")
    exts_archive: Optional[List[StrictStr]] = Field(default=None, description="Exts archive", alias="extsArchive")
    exts_video: Optional[List[StrictStr]] = Field(default=None, description="Exts video", alias="extsVideo")
    exts_audio: Optional[List[StrictStr]] = Field(default=None, description="Exts audio", alias="extsAudio")
    exts_image: Optional[List[StrictStr]] = Field(default=None, description="Exts image", alias="extsImage")
    exts_spreadsheet: Optional[List[StrictStr]] = Field(default=None, description="Exts spreadsheet", alias="extsSpreadsheet")
    exts_presentation: Optional[List[StrictStr]] = Field(default=None, description="Exts presentation", alias="extsPresentation")
    exts_document: Optional[List[StrictStr]] = Field(default=None, description="Exts document", alias="extsDocument")
    internal_formats: Optional[FilesSettingsDtoInternalFormats] = Field(default=None, alias="internalFormats")
    master_form_extension: Optional[StrictStr] = Field(default=None, description="Master form extension", alias="masterFormExtension")
    param_version: Optional[StrictStr] = Field(default=None, description="Param version", alias="paramVersion")
    param_out_type: Optional[StrictStr] = Field(default=None, description="Param out type", alias="paramOutType")
    file_download_url_string: Optional[StrictStr] = Field(default=None, description="File download url string", alias="fileDownloadUrlString")
    file_web_viewer_url_string: Optional[StrictStr] = Field(default=None, description="File web viewer url string", alias="fileWebViewerUrlString")
    file_web_viewer_external_url_string: Optional[StrictStr] = Field(default=None, description="File web viewer external url string", alias="fileWebViewerExternalUrlString")
    file_web_editor_url_string: Optional[StrictStr] = Field(default=None, description="File web editor url string", alias="fileWebEditorUrlString")
    file_web_editor_external_url_string: Optional[StrictStr] = Field(default=None, description="File web editor external url string", alias="fileWebEditorExternalUrlString")
    file_redirect_preview_url_string: Optional[StrictStr] = Field(default=None, description="File redirect preview url string", alias="fileRedirectPreviewUrlString")
    file_thumbnail_url_string: Optional[StrictStr] = Field(default=None, description="File thumbnail url string", alias="fileThumbnailUrlString")
    confirm_delete: Optional[StrictBool] = Field(default=None, description="Confirm delete", alias="confirmDelete")
    enable_third_party: Optional[StrictBool] = Field(default=None, description="EnableT third party", alias="enableThirdParty")
    external_share: Optional[StrictBool] = Field(default=None, description="External share", alias="externalShare")
    external_share_social_media: Optional[StrictBool] = Field(default=None, description="External share social media", alias="externalShareSocialMedia")
    store_original_files: Optional[StrictBool] = Field(default=None, description="Store original files", alias="storeOriginalFiles")
    keep_new_file_name: Optional[StrictBool] = Field(default=None, description="Keep new file name", alias="keepNewFileName")
    display_file_extension: Optional[StrictBool] = Field(default=None, description="Display file extension", alias="displayFileExtension")
    convert_notify: Optional[StrictBool] = Field(default=None, description="Convert notify", alias="convertNotify")
    hide_confirm_cancel_operation: Optional[StrictBool] = Field(default=None, description="Hide confirm cancel operation", alias="hideConfirmCancelOperation")
    hide_confirm_convert_save: Optional[StrictBool] = Field(default=None, description="HideC confirm convert save", alias="hideConfirmConvertSave")
    hide_confirm_convert_open: Optional[StrictBool] = Field(default=None, description="Hide confirm convert open", alias="hideConfirmConvertOpen")
    hide_confirm_room_lifetime: Optional[StrictBool] = Field(default=None, description="Hide confirm room lifetime", alias="hideConfirmRoomLifetime")
    default_order: Optional[OrderBy] = Field(default=None, alias="defaultOrder")
    forcesave: Optional[StrictBool] = Field(default=None, description="Forcesave")
    store_forcesave: Optional[StrictBool] = Field(default=None, description="Store forcesave", alias="storeForcesave")
    recent_section: Optional[StrictBool] = Field(default=None, description="Recent section", alias="recentSection")
    favorites_section: Optional[StrictBool] = Field(default=None, description="Favorites section", alias="favoritesSection")
    templates_section: Optional[StrictBool] = Field(default=None, description="Templates section", alias="templatesSection")
    download_tar_gz: Optional[StrictBool] = Field(default=None, description="Download tar gz", alias="downloadTarGz")
    automatically_clean_up: Optional[AutoCleanUpData] = Field(default=None, alias="automaticallyCleanUp")
    can_search_by_content: Optional[StrictBool] = Field(default=None, description="Can search by content", alias="canSearchByContent")
    default_sharing_access_rights: Optional[List[FileShare]] = Field(default=None, description="Default sharing access rights", alias="defaultSharingAccessRights")
    max_upload_thread_count: Optional[StrictInt] = Field(default=None, description="Max upload thread count", alias="maxUploadThreadCount")
    chunk_upload_size: Optional[StrictInt] = Field(default=None, description="Chunk upload size", alias="chunkUploadSize")
    open_editor_in_same_tab: Optional[StrictBool] = Field(default=None, description="Open editor in same tab", alias="openEditorInSameTab")
