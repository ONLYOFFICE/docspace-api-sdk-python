...
class AceShortWrapper(BaseModel):
    ...
    permissions: Optional[StrictStr] = Field(default=None, description="User access rights to the file")
    is_link: Optional[StrictBool] = Field(default=None, description="Is link", alias="isLink")
