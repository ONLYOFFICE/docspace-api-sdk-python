...
class ConfigurationDtoInteger(BaseModel):
    ...
    editor_url: Optional[StrictStr] = Field(default=None, description="Editor URL", alias="editorUrl")
    token: Optional[StrictStr] = Field(default=None, description="Token")
    type: Optional[StrictStr] = Field(default=None, description="Platform type")
    ...
    filling_session_id: Optional[StrictStr] = Field(default=None, description="Filling session Id", alias="fillingSessionId")
    __properties: ClassVar[List[str]] = ["document", "documentType", "editorConfig", "editorType", "editorUrl", "token", "type", "file", "errorMessage", "startFilling", "fillingSessionId"]
