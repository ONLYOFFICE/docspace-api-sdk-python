...
class StartEdit(BaseModel):
    ...
    """ # noqa: E501
    editing_alone: Optional[StrictBool] = Field(default=None, description="Specifies whether to share a file with other users for editing or not", alias="editingAlone")
