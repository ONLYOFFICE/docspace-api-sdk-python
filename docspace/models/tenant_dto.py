...
class TenantDto(BaseModel):
    ...
    TenantDto
    """ # noqa: E501
    affiliate_id: Optional[StrictStr] = Field(default=None, description="Affiliate ID", alias="affiliateId")
    ...
    campaign: Optional[StrictStr] = Field(default=None, description="Campaign")
    creation_date_time: Optional[datetime] = Field(default=None, description="Creation date and time", alias="creationDateTime")
    hosted_region: Optional[StrictStr] = Field(default=None, description="Hosted region", alias="hostedRegion")
    ...
    mapped_domain: Optional[StrictStr] = Field(default=None, description="Mapped domain", alias="mappedDomain")
    ...
    trusted_domains_raw: Optional[StrictStr] = Field(default=None, description="Trusted domains in the string format", alias="trustedDomainsRaw")
