...
class SessionRequest(BaseModel):
    ...
    file_size: Optional[StrictInt] = Field(default=None, description="File length in bytes", alias="fileSize")
    relative_path: Optional[StrictStr] = Field(default=None, description="Relative path to the folder", alias="relativePath")
    create_on: Optional[ApiDateTime] = Field(default=None, alias="createOn")
    encrypted: Optional[StrictBool] = Field(default=None, description="Specifies whether to encrypt a file or not")
