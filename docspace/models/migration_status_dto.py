...
class MigrationStatusDto(BaseModel):
    ...
    MigrationStatusDto
    """ # noqa: E501
    progress: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Migration progress")
    error: Optional[StrictStr] = Field(default=None, description="Migration error")
    parse_result: Optional[MigrationApiInfo] = Field(default=None, alias="parseResult")
    is_completed: Optional[StrictBool] = Field(default=None, description="Specifies whether the migration is completed", alias="isCompleted")
