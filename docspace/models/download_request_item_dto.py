...
class DownloadRequestItemDto(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[DownloadRequestItemDtoKey] = None
    value: Optional[StrictStr] = Field(default=None, description="The target format or conversion type for the file download")
    password: Optional[StrictStr] = Field(default=None, description="Optional password for accessing protected files")
