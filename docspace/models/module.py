...
class Module(BaseModel):
    ...
    app_name: Optional[StrictStr] = Field(default=None, description="Product class name", alias="appName")
    title: Optional[StrictStr] = Field(default=None, description="Title")
    link: Optional[StrictStr] = Field(default=None, description="Start link")
    icon_url: Optional[StrictStr] = Field(default=None, description="Icon URL", alias="iconUrl")
    image_url: Optional[StrictStr] = Field(default=None, description="Large image URL", alias="imageUrl")
    help_url: Optional[StrictStr] = Field(default=None, description="Help URL", alias="helpUrl")
