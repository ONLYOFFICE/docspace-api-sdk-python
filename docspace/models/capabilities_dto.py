...
class CapabilitiesDto(BaseModel):
    ...
    ldap_domain: Optional[StrictStr] = Field(default=None, description="Ldap domain", alias="ldapDomain")
    providers: Optional[List[StrictStr]] = Field(default=None, description="List of providers")
    sso_label: Optional[StrictStr] = Field(default=None, description="SP login label", alias="ssoLabel")
    oauth_enabled: Optional[StrictBool] = Field(default=None, description="Specifies if OAuth is enabled or not", alias="oauthEnabled")
    sso_url: Optional[StrictStr] = Field(default=None, description="SSO URL. If this parameter is empty, then the SSO settings are disabled", alias="ssoUrl")
