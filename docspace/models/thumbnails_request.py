...
class ThumbnailsRequest(BaseModel):
    ...
    """ # noqa: E501
    tmp_file: Optional[StrictStr] = Field(default=None, description="Path to the temporary file", alias="tmpFile")
    x: Optional[StrictInt] = Field(default=None, description="Horizontal coordinate")
    y: Optional[StrictInt] = Field(default=None, description="Vertical coordinate")
