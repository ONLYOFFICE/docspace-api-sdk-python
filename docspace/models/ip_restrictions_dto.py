...
class IpRestrictionsDto(BaseModel):
    ...
    """ # noqa: E501
    ip_restrictions: Optional[List[IpRestrictionBase]] = Field(default=None, description="List of IP addresses", alias="ipRestrictions")
    enable: Optional[StrictBool] = Field(default=None, description="Enables IP restrictions or not")
