...
class CheckFillFormDraft(BaseModel):
    ...
    action: Optional[StrictStr] = Field(default=None, description="Action with a form")
    request_view: Optional[StrictBool] = Field(default=None, description="Specifies whether to request a form for viewing or not", alias="requestView")
